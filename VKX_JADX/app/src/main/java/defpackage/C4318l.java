...
/* JADX INFO: renamed from: lؖۖٚ, reason: invalid class name and case insensitive filesystem */
/* JADX INFO: compiled from: r8-map-id-7761d6fd52750600b6eeb3da7b88ede05d5cd0fcaae415e0ed7a2830c95bc1fb */
/* JADX INFO: loaded from: classes3.dex */
public final class C4318l implements InterfaceC14185l {
    public final InterfaceC18528l amazon;
    public final HashMap crashlytics;
    public final HashMap loadAd;
    public final C13128l purchase = new C13128l(this, 1);
    public OutputStream yandex;
    public static final Charset billing = Charset.forName("UTF-8");
    public static final C3537l mopub = new C3537l("key", AbstractC12900l.startapp(AbstractC9029l.startapp(InterfaceC16996l.class, new C7601l(1))));
    public static final C3537l admob = new C3537l("value", AbstractC12900l.startapp(AbstractC9029l.startapp(InterfaceC16996l.class, new C7601l(2))));
    public static final C4267l subs = C4267l.loadAd;

    public C4318l(ByteArrayOutputStream byteArrayOutputStream, HashMap map, HashMap map2, InterfaceC18528l interfaceC18528l) {
    ...
    public static int isPro(C3537l c3537l) {
        InterfaceC16996l interfaceC16996l = (InterfaceC16996l) c3537l.loadAd(InterfaceC16996l.class);
        if (interfaceC16996l != null) {
            return interfaceC16996l.zza();
        }
    ...
    public final void admob(C3537l c3537l, int i, boolean z) {
        ...
        int iOrdinal = interfaceC16996l.zzb().ordinal();
        if (iOrdinal == 0) {
            smaato(interfaceC16996l.zza() << 3);
            smaato(i);
        } else if (iOrdinal == 1) {
            smaato(interfaceC16996l.zza() << 3);
            smaato((i + i) ^ (i >> 31));
            ...
            smaato((interfaceC16996l.zza() << 3) | 5);
    ...
    public final void crashlytics(C3537l c3537l, Object obj, boolean z) {
        ...
        if (obj instanceof InterfaceC13590l) {
            admob(c3537l, ((InterfaceC13590l) obj).zza(), true);
    ...
    public final void subs(C3537l c3537l, long j, boolean z) throws IOException {
        ...
        if (iOrdinal == 0) {
            ...
            smaato((interfaceC16996l.zza() << 3) | 1);
