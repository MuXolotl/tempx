...
/* JADX INFO: renamed from: lٟؓۖ, reason: invalid class name and case insensitive filesystem */
...
public abstract class AbstractC2020l {
    ...
    static {
        AbstractC2020l.class.getClassLoader();
    }
    ...
    public static void loadAd(Parcel parcel, IInterface iInterface) {
        if (iInterface == null) {
