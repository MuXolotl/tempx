...
/* JADX INFO: renamed from: lؗۖۡ, reason: invalid class name and case insensitive filesystem */
/* JADX INFO: compiled from: r8-map-id-7761d6fd52750600b6eeb3da7b88ede05d5cd0fcaae415e0ed7a2830c95bc1fb */
/* JADX INFO: loaded from: classes.dex */
public final /* synthetic */ class C5089l implements Function2 {

    /* JADX INFO: renamed from: lؓٝؕ, reason: contains not printable characters */
    public final /* synthetic */ InterfaceC12244l f11093l;

    /* JADX INFO: renamed from: lؗۤؑ, reason: contains not printable characters */
    public final /* synthetic */ C6922l f11094l;

    /* JADX INFO: renamed from: lٌؘؒ, reason: contains not printable characters */
    public final /* synthetic */ int f11095l;

    public /* synthetic */ C5089l(C6922l c6922l, InterfaceC12244l interfaceC12244l, int i) {
        this.f11095l = i;
        this.f11094l = c6922l;
        this.f11093l = interfaceC12244l;
    }
    ...
    public final Object invoke(Object obj, Object obj2) {
        ...
        InterfaceC12244l interfaceC12244l = this.f11093l;
        int i2 = 1;
        switch (i) {
            case 0:
                ...
                if (c6956l.m2127for(iIntValue & 1, (iIntValue & 3) != 2)) {
                    ...
                    C6922l c6922l = this.f11094l;
                    AbstractC18079l.amazon(AbstractC15300l.yandex, null, AbstractC14566l.amazon(-1554618086, new C1645l(8, c6922l), c6956l), null, 0.0f, c5587l, null, null, null, c6956l, 196998, 474);
                    String str = (String) interfaceC12244l.getValue();
                    boolean zAdmob = c6956l.admob(c6922l);
                    Object objM2132native = c6956l.m2132native();
                    if (zAdmob || objM2132native == c13863l) {
                        C3151l c3151l = new C3151l(1, c6922l, C6922l.class, "onQueryChanged", "onQueryChanged(Ljava/lang/String;)V", 0, 0, 5);
                        c6956l.m2147try(c3151l);
                        objM2132native = c3151l;
                    }
                    AbstractC10704l.purchase(str, (Function1) ((InterfaceC5059l) objM2132native), null, AbstractC4927l.amazon(AbstractC0019l.crashlytics(AbstractC0080l.amazon(AbstractC3605l.startapp(AbstractC3605l.vip(c4346l, 16.0f, 0.0f, 2), 0.0f, 0.0f, 0.0f, 16.0f, 7), 1.0f), ((C14370l) c6956l.isPro(c10707l)).crashlytics.crashlytics), ((C14370l) c6956l.isPro(c10707l)).yandex.ads, c9946l), null, AbstractC15300l.crashlytics, AbstractC15300l.amazon, AbstractC14566l.amazon(280806588, new C5089l(c6922l, interfaceC12244l, i2), c6956l), null, null, c6956l, 14352384, 788);
            ...
            default:
                ...
                if (c6956l2.m2127for(iIntValue2 & 1, (iIntValue2 & 3) != 2)) {
                    if (((String) interfaceC12244l.getValue()).length() > 0) {
                        c6956l2.m2123default(-1087161019);
                        ...
                        C6922l c6922l2 = this.f11094l;
                        boolean zAdmob2 = c6956l2.admob(c6922l2);
                        Object objM2132native2 = c6956l2.m2132native();
                        if (zAdmob2 || objM2132native2 == c13863l) {
                            objM2132native2 = new C5767l(10, c6922l2);
                        ...
                        c6956l2.m2123default(-1093055514);
                    }
