...
/* JADX INFO: renamed from: lُُٟ, reason: invalid class name and case insensitive filesystem */
/* JADX INFO: loaded from: classes3.dex */
public final class C10973l implements InterfaceC10952l, InterfaceC12184l {

    /* JADX INFO: renamed from: lؓٝؕ, reason: contains not printable characters */
    public boolean f22111l;

    /* JADX INFO: renamed from: lؓۡؑ, reason: contains not printable characters */
    public Object f22112l;
    ...
    public C10973l(byte b, int i) {
        ...
        switch (i) {
            ...
            default:
                this.f22111l = false;
                this.f22114l = null;
                this.f22117l = new int[PSKKeyManager.MAX_KEY_LENGTH_BYTES];
                this.f22116l = new int[PSKKeyManager.MAX_KEY_LENGTH_BYTES];
                this.f22118l = new int[PSKKeyManager.MAX_KEY_LENGTH_BYTES];
                this.f22112l = new int[PSKKeyManager.MAX_KEY_LENGTH_BYTES];
                this.f22113l = new int[18];
    ...
    public int crashlytics(int i) {
        return ((((int[]) this.f22117l)[i >>> 24] + ((int[]) this.f22116l)[(i >>> 16) & 255]) ^ ((int[]) this.f22118l)[(i >>> 8) & 255]) + ((int[]) this.f22112l)[i & 255];
    }
        ...
        switch (this.f22115l) {
            case 0:
                if (!(interfaceC9719l2 instanceof C13886l)) {
                    C8339l.metrica(AbstractC5020l.subscription("invalid parameter passed to Blowfish init - ", interfaceC9719l2));
                } else {
                    this.f22111l = z;
                    byte[] bArr = ((C13886l) interfaceC9719l2).f27156l;
                    this.f22114l = bArr;
                    int[] iArr = (int[]) this.f22112l;
                    int[] iArr2 = (int[]) this.f22118l;
                    int[] iArr3 = (int[]) this.f22116l;
                    int[] iArr4 = (int[]) this.f22117l;
                    int[] iArr5 = (int[]) this.f22113l;
                    int i = 4;
                    if (bArr.length >= 4 && bArr.length <= 56) {
                        System.arraycopy(f22106l, 0, iArr4, 0, PSKKeyManager.MAX_KEY_LENGTH_BYTES);
                        System.arraycopy(f22109l, 0, iArr3, 0, PSKKeyManager.MAX_KEY_LENGTH_BYTES);
                        System.arraycopy(f22107l, 0, iArr2, 0, PSKKeyManager.MAX_KEY_LENGTH_BYTES);
                        System.arraycopy(f22105l, 0, iArr, 0, PSKKeyManager.MAX_KEY_LENGTH_BYTES);
                        System.arraycopy(f22108l, 0, iArr5, 0, 18);
                        ...
                        purchase(0, 0, iArr5);
                        purchase(iArr5[16], iArr5[17], iArr4);
                        purchase(iArr4[254], iArr4[255], iArr3);
                        purchase(iArr3[254], iArr3[255], iArr2);
                        purchase(iArr2[254], iArr2[255], iArr);
                        if (!(interfaceC9719l2 instanceof EnumC2441l)) {
                            ((C5911l) AbstractC8776l.purchase.get()).getClass();
                        } else {
                            C8339l.metrica("params should not be CryptoServicePurpose");
                        }
                    } else {
                        C8339l.metrica("key length must be in range 32 to 448 bits");
                    }
                }
                break;
            case 1:
                this.f22111l = z;
                this.f22117l = new C4998l(new C10012l());
                if (interfaceC9719l2 instanceof C6114l) {
                    C6114l c6114l = (C6114l) interfaceC9719l2;
                    interfaceC9719l2 = c6114l.f12903l;
                    secureRandomLoadAd = c6114l.f12904l;
                } else {
                    secureRandomLoadAd = AbstractC8776l.loadAd();
                }
                if (interfaceC9719l2 instanceof C13886l) {
                    this.f22116l = (C13886l) interfaceC9719l2;
                    if (this.f22111l) {
                        byte[] bArr2 = new byte[8];
                        this.f22114l = bArr2;
                        secureRandomLoadAd.nextBytes(bArr2);
                        this.f22118l = new C0272l((C13886l) this.f22116l, this.f22114l);
                    }
                } else if (interfaceC9719l2 instanceof C0272l) {
                    C0272l c0272l = (C0272l) interfaceC9719l2;
                    this.f22118l = c0272l;
                    byte[] bArr3 = c0272l.f1273l;
                    this.f22114l = bArr3;
                    this.f22116l = (C13886l) c0272l.f1272l;
                    if (this.f22111l) {
                        str = (bArr3 == null || bArr3.length != 8) ? "IV is not 8 octets" : "You should not supply an IV for unwrapping";
                    }
                    C8339l.metrica(str);
                }
                break;
            default:
                if (interfaceC9719l2 instanceof C6114l) {
                    interfaceC9719l2 = ((C6114l) interfaceC9719l2).f12903l;
                }
                this.f22111l = z;
                if (!(interfaceC9719l2 instanceof C13886l)) {
                    C8339l.metrica("invalid parameters passed to DSTU7624WrapEngine");
                } else {
                    ((C7963l) this.f22117l).init(z, interfaceC9719l2);
                }
                break;
        }
    }
    ...
    public void purchase(int i, int i2, int[] iArr) {
        int[] iArr2 = (int[]) this.f22113l;
        int length = iArr.length;
        int i3 = 0;
        while (i3 < length) {
            int iCrashlytics = i ^ iArr2[0];
            for (int i4 = 1; i4 < 16; i4 += 2) {
                i2 ^= crashlytics(iCrashlytics) ^ iArr2[i4];
                iCrashlytics ^= crashlytics(i2) ^ iArr2[i4 + 1];
            }
            iArr[i3] = i2 ^ iArr2[17];
            iArr[i3 + 1] = iCrashlytics;
            int i5 = iArr[i3];
            i3 += 2;
            i2 = iCrashlytics;
            i = i5;
    ...
    public int tapsense(int i, int i2, byte[] bArr, byte[] bArr2) {
        int[] iArr = (int[]) this.f22113l;
        if (this.f22114l == null) {
            C8339l.smaato("Blowfish not initialised");
            return 0;
        }
        if (i + 8 > bArr.length) {
        ...
        if (!this.f22111l) {
            int iLoadAd = loadAd(i, bArr);
            int iLoadAd2 = loadAd(i + 4, bArr);
            int iCrashlytics = iArr[17] ^ iLoadAd;
            for (int i3 = 16; i3 > 0; i3 -= 2) {
                iLoadAd2 ^= crashlytics(iCrashlytics) ^ iArr[i3];
                iCrashlytics ^= crashlytics(iLoadAd2) ^ iArr[i3 - 1];
            }
            yandex(iArr[0] ^ iLoadAd2, i2, bArr2);
            yandex(iCrashlytics, i2 + 4, bArr2);
            return 8;
        }
        int iLoadAd3 = loadAd(i, bArr);
        int iLoadAd4 = loadAd(i + 4, bArr);
        int iCrashlytics2 = iArr[0] ^ iLoadAd3;
        for (int i4 = 1; i4 < 16; i4 += 2) {
            iLoadAd4 ^= crashlytics(iCrashlytics2) ^ iArr[i4];
            iCrashlytics2 ^= crashlytics(iLoadAd4) ^ iArr[i4 + 1];
        }
        yandex(iArr[17] ^ iLoadAd4, i2, bArr2);
        yandex(iCrashlytics2, i2 + 4, bArr2);
        return 8;
    }
        ...
        switch (this.f22115l) {
            case 1:
                if (this.f22111l) {
                    ...
                    if (bArr != null) {
                        int iLicense = ((C4998l) this.f22117l).f10232l.license();
                        if (i2 % iLicense != 0) {
                            throw new C10352l(AbstractC0653l.vip(iLicense, "Ciphertext not multiple of "));
                        }
                        ((C4998l) this.f22117l).init(false, new C0272l((C13886l) this.f22116l, f22110l, 0, 8));
                        byte[] bArr2 = new byte[i2];
                        for (int i4 = 0; i4 != i2; i4 += iLicense) {
                            ((C4998l) this.f22117l).tapsense(i4, i4, bArr, bArr2);
                        }
                        AbstractC14024l.pro(bArr2);
                        ...
                        C0272l c0272l = new C0272l((C13886l) this.f22116l, this.f22114l);
                        this.f22118l = c0272l;
                        ((C4998l) this.f22117l).init(false, c0272l);
                        byte[] bArr5 = new byte[i5];
                        for (int i6 = 0; i6 != i5; i6 += iLicense) {
                            ((C4998l) this.f22117l).tapsense(i6, i6, bArr4, bArr5);
                        }
                        int i7 = i2 - 16;
                        ...
                        C0655l c0655l = (C0655l) this.f22112l;
                        c0655l.update(bArr6, 0, i7);
                        byte[] bArr9 = (byte[]) this.f22113l;
                        c0655l.doFinal(bArr9, 0);
                        System.arraycopy(bArr9, 0, bArr8, 0, 8);
                        if (AbstractC14024l.smaato(bArr8, bArr7)) {
                            return bArr6;
                        }
                ...
                return null;
            default:
                byte[] bArr10 = (byte[]) this.f22118l;
                byte[] bArr11 = (byte[]) this.f22116l;
                ArrayList arrayList = (ArrayList) this.f22113l;
                C7963l c7963l = (C7963l) this.f22117l;
                if (this.f22111l) {
                    C8339l.smaato("not set for unwrapping");
                } else {
                    int i8 = c7963l.f16601l;
                    int i9 = c7963l.f16601l;
                    int i10 = i8 << 3;
                    if (i2 % i10 == 0) {
                        int i11 = (i2 * 2) / i10;
                        int i12 = i11 - 1;
                        ...
                        System.arraycopy(bArr, 0, bArr12, 0, i2);
                        int i14 = 2;
                        int i15 = (i9 << 3) / 2;
                        ...
                        while (i17 != 0) {
                            ...
                            System.arraycopy(bArr12, i16, bArr14, 0, i18);
                        ...
                        int i22 = 0;
                        while (i22 < i13) {
                            System.arraycopy(arrayList.get(i11 - 2), i3, bArr12, i3, (i9 << 3) / 2);
                            int i23 = (i9 << 3) / 2;
                            System.arraycopy(bArr13, i3, bArr12, i23, i23);
                            amazon(i13 - i22, bArr11);
                            int i24 = i3;
                            while (i24 < 4) {
                                int i25 = ((i9 << 3) / 2) + i24;
                                bArr12[i25] = (byte) (bArr12[i25] ^ bArr11[i24]);
                                i24++;
                                i3 = 0;
                            }
                            c7963l.tapsense(i3, i3, bArr12, bArr12);
                            System.arraycopy(bArr12, i3, bArr13, i3, (i9 << 3) / 2);
                            int i26 = i21;
                            while (i26 < i11) {
                                int i27 = i11 - i26;
                                System.arraycopy(arrayList.get(i27 - 1), 0, arrayList.get(i27), 0, (i9 << 3) / 2);
                                i3 = 0;
                                i26++;
                                i22 = i22;
                            }
                            int i28 = i3;
                            System.arraycopy(bArr12, (i9 << 3) / 2, arrayList.get(i28), i28, (i9 << 3) / 2);
                            i22++;
                            i3 = i28;
                        }
                        int i29 = i3;
                        System.arraycopy(bArr13, i29, bArr12, i29, (i9 << 3) / 2);
                        int i30 = (i9 << 3) / 2;
                        while (i3 < i12) {
                            System.arraycopy(arrayList.get(i3), i29, bArr12, i30, (i9 << 3) / 2);
                            i30 += (i9 << 3) / 2;
                            i3++;
                        }
                        int i31 = i9 << 3;
                        System.arraycopy(bArr12, i2 - i31, bArr10, i29, i31);
                        byte[] bArr15 = new byte[i2 - (i9 << 3)];
                        if (Arrays.equals(bArr10, (byte[]) this.f22112l)) {
                            System.arraycopy(bArr12, i29, bArr15, i29, i2 - (i9 << 3));
                            return bArr15;
                        }
                        C11467l.remoteconfig("checksum failed");
                    } else {
                        C10754l.ad(AbstractC14814l.remoteconfig(i9 << 3, " bytes", new StringBuilder("unwrap data must be a multiple of ")));
                    }
                }
                return null;
        }
        ...
        switch (this.f22115l) {
            case 1:
                if (this.f22111l) {
                    ...
                    byte[] bArr3 = new byte[8];
                    C0655l c0655l = (C0655l) this.f22112l;
                    c0655l.update(bArr2, 0, i2);
                    byte[] bArr4 = (byte[]) this.f22113l;
                    c0655l.doFinal(bArr4, 0);
                    ...
                    int iLicense = ((C4998l) this.f22117l).f10232l.license();
                    if (i3 % iLicense == 0) {
                        ((C4998l) this.f22117l).init(true, (C0272l) this.f22118l);
                        byte[] bArr6 = new byte[i3];
                        for (int i4 = 0; i4 != i3; i4 += iLicense) {
                            ((C4998l) this.f22117l).tapsense(i4, i4, bArr5, bArr6);
                        }
                        byte[] bArr7 = this.f22114l;
                        int length = bArr7.length + i3;
                        byte[] bArr8 = new byte[length];
                        System.arraycopy(bArr7, 0, bArr8, 0, bArr7.length);
                        System.arraycopy(bArr6, 0, bArr8, this.f22114l.length, i3);
                        AbstractC14024l.pro(bArr8);
                        ((C4998l) this.f22117l).init(true, new C0272l((C13886l) this.f22116l, f22110l, 0, 8));
                        for (int i5 = 0; i5 != length; i5 += iLicense) {
                            ((C4998l) this.f22117l).tapsense(i5, i5, bArr8, bArr8);
                        }
                        return bArr8;
                    }
                ...
                return null;
            default:
                byte[] bArr9 = (byte[]) this.f22116l;
                byte[] bArr10 = this.f22114l;
                ArrayList arrayList = (ArrayList) this.f22113l;
                C7963l c7963l = (C7963l) this.f22117l;
                if (!this.f22111l) {
                ...
                int i6 = c7963l.f16601l;
                int i7 = c7963l.f16601l;
                int i8 = i6 << 3;
                if (i2 % i8 != 0) {
                    strRemoteconfig = AbstractC14814l.remoteconfig(i7 << 3, " bytes", new StringBuilder("wrap data must be a multiple of "));
                } else {
                    if (i2 <= bArr.length) {
                        int i9 = ((i2 / i8) + 1) * 2;
                        int i10 = i9 - 1;
                        ...
                        System.arraycopy(bArr, 0, bArr11, 0, i2);
                        System.arraycopy(bArr11, 0, bArr10, 0, (i7 << 3) / 2);
                        arrayList.clear();
                        int i13 = (i7 << 3) / 2;
                        int i14 = i12 - i13;
                        while (i14 != 0) {
                            ...
                            System.arraycopy(bArr11, i13, bArr12, 0, i15);
                        ...
                        int i17 = 0;
                        while (i17 < i11) {
                            System.arraycopy(bArr10, 0, bArr11, 0, (i7 << 3) / 2);
                            int i18 = (i7 << 3) / 2;
                            System.arraycopy(arrayList.get(0), 0, bArr11, i18, i18);
                            c7963l.tapsense(0, 0, bArr11, bArr11);
                            i17++;
                            amazon(i17, bArr9);
                            for (int i19 = 0; i19 < 4; i19++) {
                                int i20 = ((i7 << 3) / 2) + i19;
                                bArr11[i20] = (byte) (bArr11[i20] ^ bArr9[i19]);
                            }
                            int i21 = (i7 << 3) / 2;
                            System.arraycopy(bArr11, i21, bArr10, 0, i21);
                            for (int i22 = 2; i22 < i9; i22++) {
                                System.arraycopy(arrayList.get(i22 - 1), 0, arrayList.get(i22 - 2), 0, (i7 << 3) / 2);
                            }
                            System.arraycopy(bArr11, 0, arrayList.get(i9 - 2), 0, (i7 << 3) / 2);
                        }
                        System.arraycopy(bArr10, 0, bArr11, 0, (i7 << 3) / 2);
                        int i23 = (i7 << 3) / 2;
                        for (int i24 = 0; i24 < i10; i24++) {
                            System.arraycopy(arrayList.get(i24), 0, bArr11, i23, (i7 << 3) / 2);
                            i23 += (i7 << 3) / 2;
                        }
                        return bArr11;
                    }
                    strRemoteconfig = "input buffer too short";
                }
                C10754l.ad(strRemoteconfig);
                return null;
        }
    }
    ...
    public C10973l(int i) {
        this.f22115l = 2;
        C7963l c7963l = new C7963l(i);
        this.f22117l = c7963l;
        int i2 = c7963l.f16601l << 3;
        this.f22114l = new byte[i2 / 2];
        this.f22118l = new byte[i2];
        this.f22112l = new byte[i2];
        this.f22113l = new ArrayList();
        this.f22116l = new byte[4];
    }
}
