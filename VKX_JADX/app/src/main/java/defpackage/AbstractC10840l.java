...
/* JADX INFO: renamed from: lُؚؖ, reason: invalid class name and case insensitive filesystem */
/* JADX INFO: loaded from: classes3.dex */
public abstract class AbstractC10840l extends KeyFactorySpi implements AsymmetricKeyInfoConverter {
    private final Cfor keyOid;
    private final Set<Cfor> keyOids;

    public AbstractC10840l(Cfor cfor) {
        this.keyOid = cfor;
        this.keyOids = null;
    }
    ...
    public PrivateKey engineGeneratePrivate(KeySpec keySpec) throws InvalidKeySpecException {
        ...
        try {
            ...
            yandex(c2756lVip.f5961l.f20787l);
    ...
    public PublicKey engineGeneratePublic(KeySpec keySpec) throws InvalidKeySpecException {
        ...
        try {
            ...
            yandex(c17029lVip.f33175l.f20787l);
    ...
    public final void yandex(Cfor cfor) throws InvalidKeySpecException {
    ...
    public AbstractC10840l(Set set) {
        this.keyOid = null;
        this.keyOids = set;
    }
}
