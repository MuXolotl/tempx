...
/* JADX INFO: renamed from: lٍۘؗ, reason: invalid class name and case insensitive filesystem */
/* JADX INFO: compiled from: r8-map-id-7761d6fd52750600b6eeb3da7b88ede05d5cd0fcaae415e0ed7a2830c95bc1fb */
/* JADX INFO: loaded from: classes.dex */
public final class C9768l implements InterfaceC15267l {
    public final C2620l yandex;

    public C9768l(C2620l c2620l) {
        this.yandex = c2620l;
    }
    ...
    public final String toString() {
        return "BackgroundModifier(colorProvider=" + this.yandex + ')';
    }
}
