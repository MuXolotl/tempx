...
/* JADX INFO: renamed from: lٖ٘ۥ, reason: invalid class name and case insensitive filesystem */
/* JADX INFO: compiled from: r8-map-id-7761d6fd52750600b6eeb3da7b88ede05d5cd0fcaae415e0ed7a2830c95bc1fb */
/* JADX INFO: loaded from: classes3.dex */
public enum EnumC17969l {
    ACOUSTID_FINGERPRINT(FrameBodyTXXX.ACOUSTID_FINGERPRINT),
    ...
    KEY("Key"),
    LANGUAGE(DataTypes.OBJ_LANGUAGE),
    LYRICIST("Lyricist"),
    ...
    QUALITY("Quality"),
    RANKING("Ranking"),
    RATING(DataTypes.OBJ_RATING),
    RECORD_LABEL("Record Label"),
    REMIXER("Remixer"),
    SCRIPT(FrameBodyTXXX.SCRIPT),
    ...
    public final String f35133l;

    EnumC17969l(String str) {
        this.f35133l = str;
    }
