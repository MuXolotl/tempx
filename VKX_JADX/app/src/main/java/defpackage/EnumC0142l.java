...
/* JADX INFO: renamed from: lؘؑٙ, reason: invalid class name and case insensitive filesystem */
...
public enum EnumC0142l {
    ...
    public static final Map f1042l;

    /* JADX INFO: renamed from: lٌؘؒ, reason: contains not printable characters */
    public final char f1043l;

    static {
        HashMap map = new HashMap();
        for (EnumC0142l enumC0142l : values()) {
            if (map.put(Character.valueOf(enumC0142l.f1043l), enumC0142l) != null) {
                C8339l.smaato("duplicate format character: ".concat(String.valueOf(enumC0142l)));
                return;
            }
        }
        f1042l = DesugarCollections.unmodifiableMap(map);
    }
