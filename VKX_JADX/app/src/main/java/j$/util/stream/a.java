...
public abstract class a implements g {
    ...
    public final void A(Spliterator spliterator, l5 l5Var) {
        ...
        if (y6.SHORT_CIRCUIT.o(this.f)) {
            B(spliterator, l5Var);
            return;
        }
        l5Var.h(spliterator.getExactSizeIfKnown());
    ...
    public final Object D(e8 e8Var) {
        ...
        this.h = true;
        return this.a.k ? e8Var.b(this, O(e8Var.c())) : e8Var.a(this, O(e8Var.c()));
    }
    ...
    public Spliterator L(a aVar, Spliterator spliterator) {
        return K(aVar, spliterator, new j$.time.f(14)).spliterator();
    }
    ...
    public final Spliterator T(Spliterator spliterator) {
        return this.e == 0 ? spliterator : Q(this, new j$.time.s(4, spliterator), this.a.k);
    }
    ...
    public Spliterator spliterator() {
        ...
        a aVar = this.a;
        if (this != aVar) {
            return Q(this, new j$.time.s(3, this), aVar.k);
        }
        Spliterator spliterator = aVar.g;
        if (spliterator == null) {
            throw new IllegalStateException("source already consumed or closed");
