...
public final class d6 extends y implements p8 {
    ...
    public Spliterator L(a aVar, Spliterator spliterator) {
        switch (this.l) {
            case 1:
                return y6.ORDERED.o(aVar.f) ? K(aVar, spliterator, new c1(24)).spliterator() : new t8((j$.util.t0) aVar.T(spliterator), 1);
            case 2:
                return y6.ORDERED.o(aVar.f) ? K(aVar, spliterator, new c1(25)).spliterator() : new t8((j$.util.t0) aVar.T(spliterator), 0);
            default:
    ...
    public final l5 N(int i, l5 l5Var) {
        switch (this.l) {
            case 0:
                ...
                return y6.SIZED.o(i) ? new i6(l5Var) : new a6(l5Var);
            case 1:
