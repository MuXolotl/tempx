...
public final class v5 extends b {
    ...
    public final void onCompletion(CountedCompleter countedCompleter) {
        ...
        if (dVar != null) {
            ...
            if (this.i) {
                this.n = 0L;
                g2VarF = v3.H(this.j.I());
            } else if (this.n == 0) {
                g2VarF = v3.H(this.j.I());
            } else {
                g2VarF = ((v5) this.d).n == 0 ? (g2) ((v5) this.e).i() : v3.F(this.j.I(), (g2) ((v5) this.d).i(), (g2) ((v5) this.e).i());
            }
            g2 g2VarE = g2VarF;
            if (b()) {
                g2VarE = g2VarE.e(this.l, this.m >= 0 ? Math.min(g2VarE.count(), this.l + this.m) : this.n, this.k);
            }
            d(g2VarE);
            this.o = true;
        }
