...
public final class a0 extends c {
    ...
    @Override // j$.time.chrono.c, j$.time.chrono.ChronoLocalDate
    public final k F() {
        return R() >= 1 ? b0.ROC : b0.BEFORE_ROC;
    }

    @Override // j$.time.chrono.c, j$.time.chrono.ChronoLocalDate
    public final ChronoLocalDate H(j$.time.temporal.o oVar) {
        return (a0) super.H(oVar);
    }
    ...
    public final a0 c(long j, TemporalField temporalField) {
        int iA;
        int i;
        int i2;
        if (!(temporalField instanceof ChronoField)) {
            return (a0) super.c(j, temporalField);
        }
        ...
        if (i3 == 4) {
            iA = y.c.r(chronoField).a(j, chronoField);
            ...
            if (i != 4) {
                ...
                return T(localDate.f0(i2));
            }
            if (i != 6) {
                return T(this.a.f0(iA + 1911));
            }
            if (i == 7) {
                return T(this.a.f0(1912 - R()));
            }
        } else {
            if (i3 == 5) {
                y.c.r(chronoField).b(j, chronoField);
                long jR = ((long) R()) * 12;
    ...
    public final a0 T(LocalDate localDate) {
    ...
    public final j$.time.temporal.s l(TemporalField temporalField) {
        ...
        if (i != 4) {
            return y.c.r(chronoField);
        }
        j$.time.temporal.s sVar = ChronoField.YEAR.b;
        return j$.time.temporal.s.f(1L, R() <= 0 ? (-sVar.a) + 1912 : sVar.d - 1911);
    }

    @Override // j$.time.chrono.c, j$.time.chrono.ChronoLocalDate
    /* JADX INFO: renamed from: s */
    public final ChronoLocalDate y(long j, j$.time.temporal.q qVar) {
        return (a0) super.y(j, qVar);
    }
