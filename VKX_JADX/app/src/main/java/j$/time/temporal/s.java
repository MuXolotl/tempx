...
public final class s implements Serializable {
    ...
    public static s f(long j, long j2) {
        ...
        j$.time.d.c("Minimum value must be less than maximum value");
        return null;
    }

    public static s g(long j, long j2, long j3) {
        if (j > 1) {
            j$.time.d.c("Smallest minimum value must be less than largest minimum value");
            return null;
        }
        if (j2 > j3) {
            j$.time.d.c("Smallest maximum value must be less than largest maximum value");
            return null;
        }
        if (1 <= j3) {
