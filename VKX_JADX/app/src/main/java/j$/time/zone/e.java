...
public final class e implements Serializable {
    ...
    public static e a(DataInput dataInput) {
        ...
        Month monthQ = Month.Q(i >>> 28);
        int i2 = ((264241152 & i) >>> 22) - 32;
        int i3 = (3670016 & i) >>> 19;
        DayOfWeek dayOfWeekN = i3 == 0 ? null : DayOfWeek.N(i3);
        int i4 = (507904 & i) >>> 14;
        ...
        if (i4 == 31) {
            ...
            ChronoField.SECOND_OF_DAY.E(j);
            int i8 = (int) (j / 3600);
            eVar = null;
            long j2 = j - ((long) (i8 * 3600));
            int i9 = (int) (j2 / 60);
            localTimeN = LocalTime.N(i8, i9, (int) (j2 - ((long) (i9 * 60))), 0);
        } else {
            eVar = null;
            int i10 = i4 % 24;
            LocalTime localTime2 = LocalTime.MIN;
            ChronoField.HOUR_OF_DAY.E(i10);
            localTimeN = LocalTime.f[i10];
        }
        ...
        Objects.a(localTimeN, "time");
        Objects.a(dVar, "timeDefnition");
        Objects.a(zoneOffsetOfTotalSeconds2, "standardOffset");
        Objects.a(zoneOffset, "offsetBefore");
        Objects.a(zoneOffsetOfTotalSeconds3, "offsetAfter");
        if (i2 < -28 || i2 > 31 || i2 == 0) {
            j$.time.d.c("Day of month indicator must be between -28 and 31 inclusive excluding zero");
            return eVar;
        }
        if (z && !localTimeN.equals(LocalTime.e)) {
            j$.time.d.c("Time must be midnight when end of day flag is true");
            return eVar;
        }
        if (localTimeN.d == 0) {
            return new e(monthQ, i2, dayOfWeekN, localTimeN, z, dVar, zoneOffsetOfTotalSeconds2, zoneOffset, zoneOffsetOfTotalSeconds3);
        }
        j$.time.d.c("Time's nano-of-second must be zero");
        return eVar;
    }
    ...
    public final int hashCode() {
        int iY = ((this.d.Y() + (this.e ? 1 : 0)) << 15) + (this.a.ordinal() << 11) + ((this.b + 32) << 5);
        DayOfWeek dayOfWeek = this.c;
        return this.i.hashCode() ^ ((this.g.hashCode() ^ (this.f.ordinal() + (iY + ((dayOfWeek == null ? 7 : dayOfWeek.ordinal()) << 2)))) ^ this.h.hashCode());
    }
