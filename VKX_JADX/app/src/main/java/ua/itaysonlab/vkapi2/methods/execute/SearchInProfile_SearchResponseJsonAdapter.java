...
public final class SearchInProfile_SearchResponseJsonAdapter extends AbstractC7188l {
    public final AbstractC7188l crashlytics;
    public final AbstractC7188l loadAd;
    public final C0458l yandex = C0458l.m547strictfp("playlists", "audios");

    public SearchInProfile_SearchResponseJsonAdapter(C12952l c12952l) {
        C5746l c5746l = C5746l.f12138l;
        this.loadAd = c12952l.loadAd(SearchInProfile$SearchPlaylistResponse.class, c5746l, "playlists");
    ...
    public final void billing(C3631l c3631l, Object obj) {
        ...
        this.loadAd.billing(c3631l, searchInProfile$SearchResponse.yandex);
        c3631l.isVip("audios");
        this.crashlytics.billing(c3631l, searchInProfile$SearchResponse.loadAd);
        c3631l.adcel();
    }
    ...
    public final Object loadAd(C0396l c0396l) throws C8413l, EOFException {
        ...
        while (c0396l.m504package()) {
            ...
            if (iM503l == -1) {
                ...
                if (objLoadAd == null) {
                    setLicense = AbstractC2812l.isVip("playlists", "playlists", c0396l, setLicense);
                    z = true;
                } else {
                    searchInProfile$SearchPlaylistResponse = (SearchInProfile$SearchPlaylistResponse) objLoadAd;
                }
            } else if (iM503l == 1) {
        ...
        if ((!z) & (searchInProfile$SearchPlaylistResponse == null)) {
            setLicense = AbstractC2812l.license("playlists", "playlists", c0396l, setLicense);
        }
        if ((!z2) & (list == null)) {
