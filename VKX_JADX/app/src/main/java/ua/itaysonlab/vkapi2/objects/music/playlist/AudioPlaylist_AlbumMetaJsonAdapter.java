...
public final class AudioPlaylist_AlbumMetaJsonAdapter extends AbstractC7188l {
    public final AbstractC7188l loadAd;
    public final C0458l yandex = C0458l.m547strictfp("type", "view");

    public AudioPlaylist_AlbumMetaJsonAdapter(C12952l c12952l) {
    ...
    public final void billing(C3631l c3631l, Object obj) {
        ...
        AudioPlaylist.AlbumMeta albumMeta = (AudioPlaylist.AlbumMeta) obj;
        c3631l.mopub();
        c3631l.isVip("type");
        String str = albumMeta.yandex;
        AbstractC7188l abstractC7188l = this.loadAd;
        abstractC7188l.billing(c3631l, str);
        c3631l.isVip("view");
        abstractC7188l.billing(c3631l, albumMeta.loadAd);
        c3631l.adcel();
    }
    ...
    public final Object loadAd(C0396l c0396l) throws C8413l, EOFException {
        ...
        while (c0396l.m504package()) {
            ...
            if (iM503l != -1) {
                ...
                if (iM503l == 0) {
                    ...
                    if (objLoadAd2 == null) {
                        setLicense = AbstractC2812l.isVip("view", "view", c0396l, setLicense);
                        z2 = true;
                    } else {
        ...
        if ((!z2) & (str2 == null)) {
            setLicense = AbstractC2812l.license("view", "view", c0396l, setLicense);
        }
        if (setLicense.size() == 0) {
            return new AudioPlaylist.AlbumMeta(str, str2);
        }
    ...
    public final String toString() {
        return "GeneratedJsonAdapter(AudioPlaylist.AlbumMeta)";
    }
}
