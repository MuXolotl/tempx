...
public final class NewsfeedCaptionJsonAdapter extends AbstractC7188l {
    public final AbstractC7188l loadAd;
    public final C0458l yandex = C0458l.m547strictfp("type");

    public NewsfeedCaptionJsonAdapter(C12952l c12952l) {
    ...
    public final void billing(C3631l c3631l, Object obj) {
        ...
        c3631l.mopub();
        c3631l.isVip("type");
        this.loadAd.billing(c3631l, ((NewsfeedCaption) obj).yandex);
        c3631l.adcel();
    }
    ...
    public final Object loadAd(C0396l c0396l) throws C8413l, EOFException {
        ...
        if (setLicense.size() == 0) {
            return new NewsfeedCaption(str);
        }
    ...
    public final String toString() {
        return "GeneratedJsonAdapter(NewsfeedCaption)";
    }
}
