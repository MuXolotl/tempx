...
public final class OriginalPlaylistJsonAdapter extends AbstractC7188l {
    public final AbstractC7188l amazon;
    public final AbstractC7188l crashlytics;
    public final AbstractC7188l loadAd;
    public final C0458l yandex = C0458l.m547strictfp("owner_id", "playlist_id", "access_key");

    public OriginalPlaylistJsonAdapter(C12952l c12952l) {
        Class cls = Long.TYPE;
        C5746l c5746l = C5746l.f12138l;
        this.loadAd = c12952l.loadAd(cls, c5746l, "owner_id");
        this.crashlytics = c12952l.loadAd(Integer.TYPE, c5746l, "playlist_id");
    ...
    public final void billing(C3631l c3631l, Object obj) {
        ...
        AbstractC12589l.m3427throws(originalPlaylist.yandex, this.loadAd, c3631l, "playlist_id");
        AbstractC12589l.inmobi(originalPlaylist.loadAd, this.crashlytics, c3631l, "access_key");
        this.amazon.billing(c3631l, originalPlaylist.crashlytics);
        c3631l.adcel();
    }
    ...
    public final Object loadAd(C0396l c0396l) throws C8413l, EOFException {
        ...
        while (c0396l.m504package()) {
            ...
            if (iM503l == -1) {
                ...
                str = (String) this.amazon.loadAd(c0396l);
            }
        }
        c0396l.ads();
        if ((!z) & (l == null)) {
