...
public final class FollowedMetadataJsonAdapter extends AbstractC7188l {
    public final AbstractC7188l crashlytics;
    public final AbstractC7188l loadAd;
    public final C0458l yandex = C0458l.m547strictfp("playlist_id", "owner_id");

    public FollowedMetadataJsonAdapter(C12952l c12952l) {
        Class cls = Integer.TYPE;
        C5746l c5746l = C5746l.f12138l;
        this.loadAd = c12952l.loadAd(cls, c5746l, "playlist_id");
    ...
    public final void billing(C3631l c3631l, Object obj) {
        ...
        AbstractC12589l.inmobi(followedMetadata.yandex, this.loadAd, c3631l, "owner_id");
        this.crashlytics.billing(c3631l, Long.valueOf(followedMetadata.loadAd));
        c3631l.adcel();
    }
    ...
    public final Object loadAd(C0396l c0396l) throws C8413l, EOFException {
        ...
        if (setLicense.size() == 0) {
            return new FollowedMetadata(num.intValue(), l.longValue());
        }
    ...
    public final String toString() {
        return "GeneratedJsonAdapter(FollowedMetadata)";
    }
}
