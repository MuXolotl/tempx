...
public final class Catalog2BannerClickActionRootJsonAdapter extends AbstractC7188l {
    public final AbstractC7188l loadAd;
    public final C0458l yandex = C0458l.m547strictfp("action");

    public Catalog2BannerClickActionRootJsonAdapter(C12952l c12952l) {
        this.loadAd = c12952l.loadAd(Catalog2ButtonAction.class, C5746l.f12138l, "action");
    }
    ...
    public final void billing(C3631l c3631l, Object obj) {
        ...
        c3631l.mopub();
        c3631l.isVip("action");
        this.loadAd.billing(c3631l, ((Catalog2BannerClickActionRoot) obj).yandex);
        c3631l.adcel();
    }
    ...
    public final Object loadAd(C0396l c0396l) throws C8413l, EOFException {
        ...
        if (setLicense.size() == 0) {
            return new Catalog2BannerClickActionRoot(catalog2ButtonAction);
        }
    ...
    public final String toString() {
        return "GeneratedJsonAdapter(Catalog2BannerClickActionRoot)";
    }
}
