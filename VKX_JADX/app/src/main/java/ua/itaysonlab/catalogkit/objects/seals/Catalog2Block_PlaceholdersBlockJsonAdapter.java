...
public final class Catalog2Block_PlaceholdersBlockJsonAdapter extends AbstractC7188l {
    public final AbstractC7188l amazon;
    public final AbstractC7188l billing;
    public final AbstractC7188l crashlytics;
    public final AbstractC7188l loadAd;
    public final AbstractC7188l purchase;
    public final C0458l yandex = C0458l.m547strictfp("id", "layout", "actions", "listen_events", "next_from", "placeholder_ids");

    public Catalog2Block_PlaceholdersBlockJsonAdapter(C12952l c12952l) {
    ...
    public final void billing(C3631l c3631l, Object obj) {
        ...
        c3631l.mopub();
        c3631l.isVip("id");
        this.loadAd.billing(c3631l, placeholdersBlock.yandex);
        c3631l.isVip("layout");
        this.crashlytics.billing(c3631l, placeholdersBlock.loadAd);
        c3631l.isVip("actions");
        this.amazon.billing(c3631l, placeholdersBlock.crashlytics);
        c3631l.isVip("listen_events");
        List list = placeholdersBlock.amazon;
        AbstractC7188l abstractC7188l = this.purchase;
        abstractC7188l.billing(c3631l, list);
        c3631l.isVip("next_from");
        this.billing.billing(c3631l, placeholdersBlock.purchase);
        c3631l.isVip("placeholder_ids");
        abstractC7188l.billing(c3631l, placeholdersBlock.billing);
        c3631l.adcel();
    }
    ...
    public final Object loadAd(C0396l c0396l) throws C8413l, EOFException {
        ...
        String str2 = str;
        if (i == -61) {
            return new Catalog2Block.PlaceholdersBlock(str2, (String) objLoadAd3, (List) objLoadAd, (List) objLoadAd2, (List) objLoadAd4, catalog2Layout);
        }
        return new Catalog2Block.PlaceholdersBlock(i, str, (String) objLoadAd3, (List) objLoadAd, (List) objLoadAd2, (List) objLoadAd4, catalog2Layout);
    }
