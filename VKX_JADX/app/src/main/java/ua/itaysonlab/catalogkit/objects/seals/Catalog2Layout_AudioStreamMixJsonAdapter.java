...
public final class Catalog2Layout_AudioStreamMixJsonAdapter extends AbstractC7188l {
    public final AbstractC7188l loadAd;
    public final C0458l yandex = C0458l.m547strictfp("style");

    public Catalog2Layout_AudioStreamMixJsonAdapter(C12952l c12952l) {
    ...
    public final void billing(C3631l c3631l, Object obj) {
        ...
        c3631l.mopub();
        c3631l.isVip("style");
        this.loadAd.billing(c3631l, ((Catalog2Layout.AudioStreamMix) obj).yandex);
        c3631l.adcel();
    }
    ...
    public final Object loadAd(C0396l c0396l) throws C8413l, EOFException {
        ...
        if (b == -2) {
            return new Catalog2Layout.AudioStreamMix(str);
        }
        if ((b & 1) != 0) {
            str = "";
        }
    ...
    public final String toString() {
        return "GeneratedJsonAdapter(Catalog2Layout.AudioStreamMix)";
    }
}
