...
public class IvParameters extends AlgorithmParametersSpi {
    ...
    public <T extends AlgorithmParameterSpec> T engineGetParameterSpec(Class<T> cls) throws InvalidParameterSpecException {
        ...
        throw new InvalidParameterSpecException(AbstractC0653l.startapp(cls, "Incompatible AlgorithmParametersSpec class: "));
    }
    ...
    public void engineInit(AlgorithmParameterSpec algorithmParameterSpec) throws InvalidParameterSpecException {
        if (algorithmParameterSpec instanceof IvParameterSpec) {
            ...
            C17132l.startapp("Only IvParameterSpec is supported");
        }
    }
}
