...
final class OpenSSLX509CertPath extends CertPath {
    ...
    public static CertPath fromEncoding(InputStream inputStream, String str) throws CertificateException {
        ...
        throw new CertificateException(AbstractC14814l.startapp("Invalid encoding: ", str));
    }
    ...
    public byte[] getEncoded(String str) throws CertificateEncodingException {
        ...
        throw new CertificateEncodingException(AbstractC14814l.startapp("Invalid encoding: ", str));
    }
}
