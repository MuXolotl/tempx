...
final class OpenSSLRSAPrivateCrtKey extends OpenSSLRSAPrivateKey implements RSAPrivateCrtKey {
    ...
    public static OpenSSLKey getInstance(RSAPrivateCrtKey rSAPrivateCrtKey) throws InvalidKeyException {
        ...
        if (modulus == null) {
            C18073l.smaato("modulus == null");
            return null;
        }
        if (privateExponent == null) {
            C18073l.smaato("privateExponent == null");
            return null;
        }
        try {
    ...
    private static OpenSSLKey init(RSAPrivateCrtKeySpec rSAPrivateCrtKeySpec) throws InvalidKeySpecException {
        ...
        if (modulus == null) {
            C18073l.subscription("modulus == null");
            return null;
        }
        if (privateExponent == null) {
            C18073l.subscription("privateExponent == null");
            return null;
        }
        try {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RSAPrivateCrtKey) {
            ...
            if (getOpenSSLKey().isHardwareBacked()) {
                return getModulus().equals(rSAPrivateCrtKey.getModulus()) && this.publicExponent.equals(rSAPrivateCrtKey.getPublicExponent());
            }
