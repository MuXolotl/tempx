...
public abstract class OpenSSLCipherRSA extends CipherSpi {
    ...
    public byte[] engineDoFinal(byte[] bArr, int i, int i2) throws IllegalBlockSizeException {
        ...
        if (this.inputTooLarge) {
            throw new IllegalBlockSizeException(AbstractC14814l.remoteconfig(this.buffer.length, " bytes", new StringBuilder("input must be under ")));
        }
    ...
    public int engineGetKeySize(Key key) throws InvalidKeyException {
        ...
        if (key == null) {
            C18073l.smaato("RSA private or public key is null");
            return 0;
        }
        C18073l.smaato("Need RSA private or public key");
        return 0;
    }
    ...
    public void engineInitInternal(int i, Key key, AlgorithmParameterSpec algorithmParameterSpec) throws InvalidKeyException {
        if (i == 1 || i == 3) {
            ...
            if (i != 2 && i != 4) {
                throw new InvalidParameterException(AbstractC0653l.vip(i, "Unsupported opmode "));
            }
    ...
    public int keySizeBytes() {
        ...
        C8339l.smaato("cipher is not initialized");
        return 0;
    }
    ...
    public static class OAEP extends OpenSSLCipherRSA {
        ...
        private void readOAEPParameters(OAEPParameterSpec oAEPParameterSpec) throws InvalidAlgorithmParameterException {
            ...
            if ((!"MGF1".equals(upperCase) && !"1.2.840.113549.1.1.8".equals(upperCase)) || !(mGFParameters instanceof MGF1ParameterSpec)) {
                C18073l.pro("Only MGF1 supported as mask generation function");
                return;
            }
            ...
            try {
                ...
                if ("PSpecified".equals(pSource.getAlgorithm()) && (pSource instanceof PSource.PSpecified)) {
                    ...
                    C18073l.pro("Only PSpecified accepted for PSource");
                }
        ...
        public AlgorithmParameters engineGetParameters() {
            ...
            try {
                ...
                C18073l.license("No providers of AlgorithmParameters.OAEP available");
                return null;
            }
        }
        ...
        public void engineInitInternal(int i, Key key, AlgorithmParameterSpec algorithmParameterSpec) throws InvalidKeyException {
            if (i == 1 || i == 3) {
                if (!(key instanceof PublicKey)) {
                    C18073l.smaato("Only public keys may be used to encrypt");
                    return;
                }
            } else if ((i == 2 || i == 4) && !(key instanceof PrivateKey)) {
                C18073l.smaato("Only private keys may be used to decrypt");
                return;
            }
        ...
        public void engineInit(int i, Key key, AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) throws InvalidKeyException, InvalidAlgorithmParameterException {
            if (algorithmParameterSpec != null && !(algorithmParameterSpec instanceof OAEPParameterSpec)) {
                C18073l.pro("Only OAEPParameterSpec accepted in OAEP mode");
            } else {
