...
public abstract class OpenSSLCipher extends CipherSpi {
    ...
    private byte[] checkAndSetEncodedKey(int i, Key key) throws InvalidKeyException {
        ...
        if (!(key instanceof SecretKey)) {
            C18073l.smaato("Only SecretKey is supported");
            return null;
        }
        byte[] encoded = key.getEncoded();
        if (encoded == null) {
            C18073l.smaato("key.getEncoded() == null");
            return null;
        }
    ...
    public byte[] engineDoFinal(byte[] bArr, int i, int i2) {
        ...
        if (i2 > 0) {
            ...
            try {
                ...
                C18073l.Signature("our calculated buffer was too small", e);
                return null;
            }
        } else {
            openSSLCipher = this;
        ...
        try {
            ...
            C18073l.Signature("our calculated buffer was too small", e2);
            return null;
        }
    }
    ...
    public void engineSetMode(String str) throws NoSuchAlgorithmException {
        try {
            ...
            NoSuchAlgorithmException noSuchAlgorithmException = new NoSuchAlgorithmException(AbstractC14814l.startapp("No such mode: ", str));
    ...
    public void engineSetPadding(String str) throws NoSuchPaddingException {
        try {
            ...
            NoSuchPaddingException noSuchPaddingException = new NoSuchPaddingException(AbstractC14814l.startapp("No such padding: ", str));
    ...
    public byte[] engineUpdate(byte[] bArr, int i, int i2) {
        ...
        try {
            ...
            C18073l.license(AbstractC0653l.vip(outputSizeForUpdate, "calculated buffer size was wrong: "));
            return null;
        }
    }
