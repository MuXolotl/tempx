    ...
    public enum HashAlgorithm {
        ...
        public static HashAlgorithm valueOf(int i) {
            try {
                ...
                throw new IllegalArgumentException(AbstractC0653l.vip(i, "Invalid hash algorithm "), e);
            }
        }
    }
    ...
    public enum SignatureAlgorithm {
        ...
        public static SignatureAlgorithm valueOf(int i) {
            try {
                ...
                throw new IllegalArgumentException(AbstractC0653l.vip(i, "Invalid signature algorithm "), e);
            }
        }
    }
