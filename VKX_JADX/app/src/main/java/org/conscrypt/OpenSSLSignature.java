...
public class OpenSSLSignature extends SignatureSpi {
    ...
    public static abstract class RSAPSSPadding extends OpenSSLSignature {
        ...
        public final void engineSetParameter(AlgorithmParameterSpec algorithmParameterSpec) throws InvalidAlgorithmParameterException {
            ...
            if (!this.contentDigestAlgorithm.equalsIgnoreCase(jcaDigestAlgorithmStandardName)) {
                C18073l.pro("Changing content digest algorithm not supported");
                return;
            }
            ...
            if (!"MGF1".equalsIgnoreCase(mGFAlgorithm) && !"1.2.840.113549.1.1.8".equals(mGFAlgorithm)) {
                throw new InvalidAlgorithmParameterException(AbstractC15560l.Signature("Unsupported MGF algorithm: ", mGFAlgorithm, ". Only MGF1 supported"));
            }
            ...
            try {
                ...
                if (saltLength < 0) {
                    throw new InvalidAlgorithmParameterException(AbstractC0653l.vip(saltLength, "Salt length must be non-negative: "));
                }
                int trailerField = pSSParameterSpec.getTrailerField();
                if (trailerField != 1) {
                    throw new InvalidAlgorithmParameterException(AbstractC15560l.tapsense("Unsupported trailer field: ", trailerField, ". Only 1 supported"));
                }
    ...
    public byte[] engineSign() {
        try {
            ...
            C8339l.subs("Reset of context failed after it was successful once");
            return null;
        }
    }
