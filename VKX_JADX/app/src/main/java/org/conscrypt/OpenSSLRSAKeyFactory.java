...
public final class OpenSSLRSAKeyFactory extends KeyFactorySpi {
    ...
    public PrivateKey engineGeneratePrivate(KeySpec keySpec) throws InvalidKeySpecException {
        if (keySpec == null) {
            C18073l.subscription("keySpec == null");
            return null;
        }
    ...
    public <T extends KeySpec> T engineGetKeySpec(Key key, Class<T> cls) throws InvalidKeySpecException {
        ...
        if (!"RSA".equals(key.getAlgorithm())) {
            C18073l.subscription("Key must be a RSA key");
            return null;
        }
        ...
        if (z && RSAPublicKeySpec.class.isAssignableFrom(cls)) {
            ...
            if (!"X.509".equals(key.getFormat()) || encoded == null) {
                C18073l.subscription("Not a valid X.509 encoding");
                return null;
            }
        ...
        if (z3 && RSAPrivateCrtKeySpec.class.isAssignableFrom(cls)) {
            ...
            if (!"PKCS#8".equals(key.getFormat()) || encoded2 == null) {
                C18073l.subscription("Not a valid PKCS#8 encoding");
                return null;
            }
            ...
            C18073l.subscription("Encoded key is not an RSAPrivateCrtKey");
            return null;
        }
        ...
        if (z3 && PKCS8EncodedKeySpec.class.isAssignableFrom(cls)) {
            ...
            if ("PKCS#8".equals(key.getFormat())) {
                ...
                C18073l.subscription("Key is not encodable");
                return null;
            }
    ...
    public Key engineTranslateKey(Key key) throws InvalidKeyException {
        ...
        if ((key instanceof PrivateKey) && "PKCS#8".equals(key.getFormat())) {
            byte[] encoded = key.getEncoded();
            if (encoded == null) {
                C18073l.smaato("Key does not support encoding");
                return null;
            }
            try {
