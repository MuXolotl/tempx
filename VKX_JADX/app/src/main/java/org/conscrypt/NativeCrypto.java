...
public final class NativeCrypto {
    ...
    static {
        ...
        if (e == null) {
            ...
            if (length % 2 != 0) {
                C8339l.metrica("Invalid cipher list returned by get_cipher_names");
                return;
            }
            int i = length / 2;
    ...
    public static String[] checkEnabledCipherSuites(String[] strArr) {
        if (strArr == null) {
            C8339l.metrica("cipherSuites == null");
            return null;
        }
        for (int i = 0; i < strArr.length; i++) {
            String str = strArr[i];
            if (str == null) {
                C8339l.metrica(AbstractC15560l.tapsense("cipherSuites[", i, "] == null"));
                return null;
            }
            if (!str.equals(TLS_EMPTY_RENEGOTIATION_INFO_SCSV) && !strArr[i].equals(TLS_FALLBACK_SCSV) && !SUPPORTED_TLS_1_2_CIPHER_SUITES_SET.contains(strArr[i]) && !SUPPORTED_LEGACY_CIPHER_SUITES_SET.contains(strArr[i])) {
                C8339l.metrica(AbstractC0653l.ads(new StringBuilder("cipherSuite "), strArr[i], " is not supported."));
                return null;
            }
        }
        return strArr;
    ...
    public static String[] checkEnabledProtocols(String[] strArr) {
        if (strArr == null) {
            C8339l.metrica("protocols == null");
            return null;
        }
        for (String str : strArr) {
            if (str == null) {
                C8339l.metrica("protocols contains null");
                return null;
            }
            if (!str.equals(SUPPORTED_PROTOCOL_TLSV1) && !str.equals(SUPPORTED_PROTOCOL_TLSV1_1) && !str.equals(SUPPORTED_PROTOCOL_TLSV1_2) && !str.equals(SUPPORTED_PROTOCOL_TLSV1_3) && !str.equals(OBSOLETE_PROTOCOL_SSLV3)) {
                C8339l.metrica(AbstractC15560l.Signature("protocol ", str, " is not supported"));
                return null;
            }
        }
        return strArr;
    ...
    private static int getProtocolConstant(String str) {
        ...
        C8339l.subs("Unknown protocol encountered: ".concat(str));
        return 0;
    }
    ...
    private static Range getProtocolRange(String[] strArr) {
        ...
        C8339l.metrica("No protocols enabled.");
        return null;
    }
