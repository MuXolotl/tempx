...
public final class OpenSSLX509Certificate extends X509Certificate {
    ...
    public static OpenSSLX509Certificate fromX509DerInputStream(InputStream inputStream) {
        ...
        try {
            try {
                ...
                OpenSSLX509Certificate openSSLX509Certificate = new OpenSSLX509Certificate(jD2i_X509_bio);
                openSSLBIOInputStream.release();
    ...
    public static OpenSSLX509Certificate fromX509PemInputStream(InputStream inputStream) {
        ...
        try {
            try {
                ...
                OpenSSLX509Certificate openSSLX509Certificate = new OpenSSLX509Certificate(jPEM_read_bio_X509);
                openSSLBIOInputStream.release();
                return openSSLX509Certificate;
            } catch (Exception e) {
                throw new OpenSSLX509CertificateFactory.ParsingException(e);
    ...
    public int getBasicConstraints() {
        ...
        return i == -1 ? Alert.DURATION_SHOW_INDEFINITELY : i;
    }
    ...
    public boolean hasUnsupportedCriticalExtension() {
        return (NativeCrypto.get_X509_ex_flags(this.mContext, this) & AbstractC12994l.AUDIO_CONTENT_BUFFER_SIZE) != 0;
    }
