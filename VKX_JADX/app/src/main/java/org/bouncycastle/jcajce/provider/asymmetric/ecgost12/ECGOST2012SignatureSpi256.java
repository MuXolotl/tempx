...
public class ECGOST2012SignatureSpi256 extends SignatureSpi implements InterfaceC0543l, InterfaceC18049l {
    private int size = 64;
    private int halfSize = 32;
    private InterfaceC16922l digest = new C13527l();
    ...
    public void engineInitSign(PrivateKey privateKey) throws InvalidKeyException {
        if (!(privateKey instanceof InterfaceC11004l)) {
            C18073l.smaato("cannot recognise key type in ECGOST-2012-256 signer");
            return;
        }
        AbstractC2017l abstractC2017l = (AbstractC2017l) ECUtil.generatePrivateKeyParameter(privateKey);
        if (abstractC2017l.f4542l.f16362l.bitLength() > 256) {
            C18073l.smaato("key out of range for ECGOST-2012-256");
            return;
        }
        this.digest.reset();
