...
public class DH {
    ...
    public static class Mappings extends AsymmetricAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            configurableProvider.addAlgorithm("KeyAgreement", InterfaceC0543l.f1890l, "org.bouncycastle.jcajce.provider.asymmetric.dh.KeyAgreementSpi$DHwithRFC2631KDF");
            configurableProvider.addAlgorithm("KeyAgreement", InterfaceC0543l.f1885l, "org.bouncycastle.jcajce.provider.asymmetric.dh.KeyAgreementSpi$DHwithRFC2631KDF");
            ...
            registerOid(configurableProvider, InterfaceC0543l.f1860abstract, "DH", new KeyFactorySpi());
            registerOid(configurableProvider, InterfaceC15427l.f30146l, "DH", new KeyFactorySpi());
        }
    }
