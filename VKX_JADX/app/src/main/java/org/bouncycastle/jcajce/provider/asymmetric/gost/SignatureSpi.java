...
public class SignatureSpi extends java.security.SignatureSpi implements InterfaceC0543l, InterfaceC18049l {
    ...
    private InterfaceC11795l signer = new C18595l(26, false);
    ...
    public void engineInitVerify(PublicKey publicKey) throws InvalidKeyException {
        ...
        if (publicKey instanceof InterfaceC0885l) {
            abstractC8831lGeneratePublicKeyParameter = ECUtil.generatePublicKeyParameter(publicKey);
            ...
            try {
                PublicKey publicKey2 = BouncyCastleProvider.getPublicKey(C17029l.vip(publicKey.getEncoded()));
                if (!(publicKey2 instanceof InterfaceC0885l)) {
                    throw new InvalidKeyException("can't recognise key type in DSA based signer");
                }
                abstractC8831lGeneratePublicKeyParameter = ECUtil.generatePublicKeyParameter(publicKey2);
