...
public class KeyFactorySpi extends BaseKeyFactorySpi {
    private boolean isValid(Cfor cfor) {
        return cfor.ad(InterfaceC18410l.purchase) || cfor.ad(InterfaceC18410l.billing) || cfor.ad(InterfaceC18410l.subs) || cfor.ad(InterfaceC18410l.isPro);
    }

    @Override // org.bouncycastle.jcajce.provider.asymmetric.util.BaseKeyFactorySpi, java.security.KeyFactorySpi
    public PrivateKey engineGeneratePrivate(KeySpec keySpec) {
        if (keySpec instanceof C14287l) {
            return new BCECGOST3410_2012PrivateKey((C14287l) keySpec);
        }
        return keySpec instanceof ECPrivateKeySpec ? new BCECGOST3410_2012PrivateKey((ECPrivateKeySpec) keySpec) : super.engineGeneratePrivate(keySpec);
    }

    @Override // org.bouncycastle.jcajce.provider.asymmetric.util.BaseKeyFactorySpi, java.security.KeyFactorySpi
    public PublicKey engineGeneratePublic(KeySpec keySpec) {
        if (keySpec instanceof C8838l) {
            return new BCECGOST3410_2012PublicKey((C8838l) keySpec, BouncyCastleProvider.CONFIGURATION);
        }
        return keySpec instanceof ECPublicKeySpec ? new BCECGOST3410_2012PublicKey((ECPublicKeySpec) keySpec) : super.engineGeneratePublic(keySpec);
    }
    ...
    public PrivateKey generatePrivate(C2756l c2756l) throws IOException {
        ...
        if (isValid(cfor)) {
            return new BCECGOST3410_2012PrivateKey(c2756l);
        }
    ...
    public PublicKey generatePublic(C17029l c17029l) throws IOException {
        ...
        if (isValid(cfor)) {
            return new BCECGOST3410_2012PublicKey(c17029l);
        }
        C18262l.metrica(AbstractC1757l.m1037private("algorithm identifier ", cfor, " in key not recognised"));
        return null;
    }
