...
public class DSA {
    ...
    public static class Mappings extends AsymmetricAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            addSignatureAlgorithm(configurableProvider, "SHA224", "DSA", "org.bouncycastle.jcajce.provider.asymmetric.dsa.DSASigner$dsa224", InterfaceC8134l.f16941class);
            addSignatureAlgorithm(configurableProvider, "SHA256", "DSA", "org.bouncycastle.jcajce.provider.asymmetric.dsa.DSASigner$dsa256", InterfaceC8134l.f16954interface);
            addSignatureAlgorithm(configurableProvider, "SHA384", "DSA", "org.bouncycastle.jcajce.provider.asymmetric.dsa.DSASigner$dsa384", InterfaceC8134l.f16989static);
            addSignatureAlgorithm(configurableProvider, "SHA512", "DSA", "org.bouncycastle.jcajce.provider.asymmetric.dsa.DSASigner$dsa512", InterfaceC8134l.f16944default);
            addSignatureAlgorithm(configurableProvider, "SHA3-224", "DSA", "org.bouncycastle.jcajce.provider.asymmetric.dsa.DSASigner$dsaSha3_224", InterfaceC8134l.f16947final);
            addSignatureAlgorithm(configurableProvider, "SHA3-256", "DSA", "org.bouncycastle.jcajce.provider.asymmetric.dsa.DSASigner$dsaSha3_256", InterfaceC8134l.f16983new);
            addSignatureAlgorithm(configurableProvider, "SHA3-384", "DSA", "org.bouncycastle.jcajce.provider.asymmetric.dsa.DSASigner$dsaSha3_384", InterfaceC8134l.f16950goto);
            addSignatureAlgorithm(configurableProvider, "SHA3-512", "DSA", "org.bouncycastle.jcajce.provider.asymmetric.dsa.DSASigner$dsaSha3_512", InterfaceC8134l.f16991super);
            ...
            int i = 0;
            while (true) {
                Cfor[] cforArr = DSAUtil.dsaOids;
                if (i == cforArr.length) {
                    return;
                }
                AbstractC11043l.metrica(new StringBuilder("Alg.Alias.Signature."), cforArr[i], configurableProvider, "DSA");
                registerOid(configurableProvider, cforArr[i], "DSA", keyFactorySpi);
                registerOidAlgorithmParameterGenerator(configurableProvider, cforArr[i], "DSA");
                i++;
            }
        }
    }
