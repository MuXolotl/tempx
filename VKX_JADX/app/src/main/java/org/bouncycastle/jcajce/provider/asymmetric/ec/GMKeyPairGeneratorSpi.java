...
public abstract class GMKeyPairGeneratorSpi extends KeyPairGenerator {
    ...
    public static class BaseSM2 extends GMKeyPairGeneratorSpi {
        ...
        static {
            ...
            hashtable.put(192, new C6051l("prime192v1"));
            hashtable.put(239, new C6051l("prime239v1"));
            hashtable.put(Integer.valueOf(PSKKeyManager.MAX_KEY_LENGTH_BYTES), new C6051l("prime256v1"));
            hashtable.put(224, new C6051l("P-224"));
            hashtable.put(384, new C6051l("P-384"));
            hashtable.put(521, new C6051l("P-521"));
        }
        ...
        public void initialize(int i, SecureRandom secureRandom) {
            ...
            C6051l c6051l = (C6051l) ecParameters.get(Integer.valueOf(i));
            if (c6051l != null) {
                try {
                    initialize(c6051l, secureRandom);
                    return;
