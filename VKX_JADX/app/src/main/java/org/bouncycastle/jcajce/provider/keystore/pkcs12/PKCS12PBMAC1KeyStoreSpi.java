...
public class PKCS12PBMAC1KeyStoreSpi extends KeyStoreSpi implements InterfaceC0543l, InterfaceC18049l {
    ...
    private C10198l macAlgorithm = new C10198l(InterfaceC0543l.f1925while);
    ...
    public static class BCPKCS12KeyStore extends AdaptingKeyStoreSpi {
        public BCPKCS12KeyStore() {
            super(new C7633l(), new PKCS12PBMAC1KeyStoreSpi(new C7633l(), InterfaceC8134l.f16949for, InterfaceC8134l.ad));
        }
    }
    ...
    public PKCS12PBMAC1KeyStoreSpi(InterfaceC12575l interfaceC12575l, Cfor cfor, Cfor cfor2) {
    ...
    private byte[] calculatePbeMac(Cfor cfor, byte[] bArr, int i, char[] cArr, boolean z, byte[] bArr2) throws IOException {
        String str;
        Cfor cfor2 = InterfaceC0543l.f1925while;
        if (cfor2.ad(cfor)) {
            applovin applovinVar = this.macAlgorithm.f20786l;
            Cfor cfor3 = InterfaceC0543l.f1923transient;
            if (applovinVar == null) {
                byte[] bArr3 = new byte[32];
                this.helper.adcel().nextBytes(bArr3);
                C10198l c10198l = new C10198l(cfor3, new C16770l(bArr3, 65536, PSKKeyManager.MAX_KEY_LENGTH_BYTES, new C10198l(InterfaceC0543l.f1881l)));
                C10198l c10198l2 = new C10198l(InterfaceC0543l.f1898l);
                C5774l c5774l = new C5774l();
                c5774l.f12174l = c10198l;
                c5774l.f12173l = c10198l2;
                this.macAlgorithm = new C10198l(cfor2, c5774l);
            }
            C5774l c5774lVip = C5774l.vip(this.macAlgorithm.f20786l);
            if (c5774lVip != null) {
                C10198l c10198l3 = c5774lVip.f12174l;
                if (cfor3.ad(c10198l3.f20787l)) {
                    C16770l c16770lVip = C16770l.vip(c10198l3.f20786l);
                    if (c16770lVip.metrica() != null) {
                        ...
                        byte[] bArr4 = new byte[c0361l.f1426l];
    ...
    private Cipher createCipher(int i, char[] cArr, C10198l c10198l) throws InvalidKeySpecException, InvalidKeyException, InvalidAlgorithmParameterException {
        ...
        if (c10198l2 != null && !c10198l2.equals(C16770l.f32780l)) {
            secretKeySpec = secretKeyFactorySignatures.generateSecret(new C13905l(cArr, bArrTapsense, iCrashlytics, keySize, c16770lVip.ads()));
        } else if ((i == 2 || i == 4) && this.useISO8859d1ForDecryption) {
            C8094l c8094l = new C8094l(new C0655l());
            c8094l.init(new String(cArr).getBytes(StandardCharsets.ISO_8859_1), bArrTapsense, iCrashlytics);
            secretKeySpec = new SecretKeySpec(((C13886l) c8094l.generateDerivedParameters(keySize)).f27156l, "AES");
        } else {
            secretKeySpec = secretKeyFactorySignatures.generateSecret(new PBEKeySpec(cArr, bArrTapsense, iCrashlytics, keySize));
        }
        ...
        if (applovinVar instanceof Cthrow) {
            cipherSubs.init(i, secretKeySpec, new IvParameterSpec(Cthrow.premium(applovinVar).f36593l));
            return cipherSubs;
        }
        ...
        if (cclassInmobi.mo173throws(1) instanceof Cfor) {
            ...
            cipherSubs.init(i, secretKeySpec, new C7244l(c3976lVip.f8163l, AbstractC14024l.crashlytics(c3976lVip.f8164l.f36593l)));
            return cipherSubs;
        }
        ...
        try {
            ...
            cipherSubs.init(i, secretKeySpec, algorithmParametersAdvert);
            return cipherSubs;
        } catch (IOException e) {
    ...
    private void doStore(OutputStream outputStream, char[] cArr, boolean z, boolean z2) throws IOException {
        ...
        while (true) {
            ...
            if (isPBKDF2(this.keyAlgorithm)) {
                ...
                c10198l2 = new C10198l(cfor2, new C4655l(new C18282l(cfor, c16770l), new C9748l(cfor9, getAlgParams(cfor9))));
                bArrWrapKey = wrapKey(c10198l2, privateKey, cArr);
            } else {
    ...
    private static int getKeyLength(Cfor cfor) {
        return keySizeProvider.getKeySize(new C10198l(cfor)) / 8;
    }
    ...
    /* JADX WARN: Code duplicated, block: B:120:0x0351  */
    ...
    /* JADX WARN: Type inference failed for: r1v18, types: [org.bouncycastle.jcajce.provider.keystore.pkcs12.PKCS12PBMAC1KeyStoreSpi$IgnoresCaseHashtable] */
    ...
    public void engineLoad(InputStream inputStream, char[] cArr) throws IOException {
        ...
        boolean z5;
        PKCS12PBMAC1KeyStoreSpi pKCS12PBMAC1KeyStoreSpi = this;
        if (inputStream == null) {
            return;
        }
        ...
        try {
            ...
            if (c5942l == null) {
                ...
                pKCS12PBMAC1KeyStoreSpi.macAlgorithm = c17203l.f33384l;
                byte[] bArrCrashlytics = AbstractC14024l.crashlytics(c5942l.f12508l);
                pKCS12PBMAC1KeyStoreSpi.itCount = AbstractC12489l.crashlytics(c5942l.f12507l);
                pKCS12PBMAC1KeyStoreSpi.saltLength = bArrCrashlytics.length;
                byte[] bArr = Cthrow.premium(AbstractC12489l.yandex(c14148l)).f36593l;
                try {
                    cArr2 = cArr;
                    byte[] bArrCalculatePbeMac = pKCS12PBMAC1KeyStoreSpi.calculatePbeMac(pKCS12PBMAC1KeyStoreSpi.macAlgorithm.f20787l, bArrCrashlytics, pKCS12PBMAC1KeyStoreSpi.itCount, cArr2, false, bArr);
                    ...
                    if (AbstractC14024l.smaato(bArrCalculatePbeMac, bArrCrashlytics2)) {
                        ...
                        if (!AbstractC14024l.smaato(pKCS12PBMAC1KeyStoreSpi.calculatePbeMac(pKCS12PBMAC1KeyStoreSpi.macAlgorithm.f20787l, bArrCrashlytics, pKCS12PBMAC1KeyStoreSpi.itCount, cArr2, true, bArr), bArrCrashlytics2)) {
                            throw AbstractC17742l.crashlytics("PKCS12 key store mac invalid - wrong password or corrupted file", new UnrecoverableKeyException("PKCS12 key store mac invalid"));
                        }
                        z = true;
                    }
            ...
            pKCS12PBMAC1KeyStoreSpi.keys = new IgnoresCaseHashtable();
            pKCS12PBMAC1KeyStoreSpi.localIds = new IgnoresCaseHashtable();
            Cfor cfor = c14148l.f27665l;
            Cfor cfor2 = InterfaceC0543l.f1879l;
            if (cfor.ad(cfor2)) {
                C14148l[] c14148lArr = C12459l.vip(Cthrow.premium(c14148l.f27664l).f36593l).f24593l;
                int length = c14148lArr.length;
                C14148l[] c14148lArr2 = new C14148l[length];
                System.arraycopy(c14148lArr, 0, c14148lArr2, 0, length);
                int i3 = 0;
                ...
                while (i3 != length) {
                    ...
                    if (zAd) {
                        ...
                        if (c14148lArr2[i3].f27665l.ad(InterfaceC0543l.f1903l)) {
                            ...
                            char[] cArr3 = cArr2;
                            pKCS12PBMAC1KeyStoreSpi = this;
                            byte[] bArrCryptData = pKCS12PBMAC1KeyStoreSpi.cryptData(false, c10198lVip, cArr3, z5, bArr2);
                            cArr2 = cArr3;
                            boolean z7 = z5;
                            ...
                            while (i6 != cclassInmobi2.size()) {
                                ...
                                if (cfor7.ad(cfor4)) {
                                    ...
                                    zProcessShroudedKeyBag = pKCS12PBMAC1KeyStoreSpi.processShroudedKeyBag(c16258lVip2, cArr2, z7);
                                } else {
                                    if (cfor7.ad(cfor3)) {
                                        pKCS12PBMAC1KeyStoreSpi.processKeyBag(c16258lVip2);
                                    } else {
            ...
            pKCS12PBMAC1KeyStoreSpi.certs = new IgnoresCaseHashtable();
            pKCS12PBMAC1KeyStoreSpi.chainCerts = new Hashtable();
            pKCS12PBMAC1KeyStoreSpi.keyCerts = new Hashtable();
            int i7 = 0;
            while (i7 != vector.size()) {
                ...
                try {
                    ?? GenerateCertificate = pKCS12PBMAC1KeyStoreSpi.certFact.generateCertificate(new ByteArrayInputStream(((Cthrow) c15143lVip.f29696l).f36593l));
                    Cinterface cinterface = c16258l.f31821l;
                    if (cinterface != null) {
                                ...
                                if (z8) {
                                    ...
                                    if (bagAttribute != null) {
                                        if (cforM192throws.ad(cfor8)) {
                                            ...
                                            if (!pKCS12PBMAC1KeyStoreSpi.keys.keys.containsKey(strPurchase) && !pKCS12PBMAC1KeyStoreSpi.localIds.keys.containsKey(strPurchase)) {
                                                i7 = i;
                                            }
                                        } else {
                                            z4 = z3;
                    ...
                    int i9 = i7;
                    boolean z9 = z3;
                    pKCS12PBMAC1KeyStoreSpi.chainCerts.put(pKCS12PBMAC1KeyStoreSpi.new CertId(GenerateCertificate.getPublicKey()), GenerateCertificate);
                    if (!zProcessShroudedKeyBag) {
                        if (r10 != 0) {
                            byte[] bArr4 = r10.f36593l;
                            C1561l c1561l2 = AbstractC8535l.yandex;
                            pKCS12PBMAC1KeyStoreSpi.keyCerts.put(new String(AbstractC8535l.amazon(0, bArr4.length, bArr4)), GenerateCertificate);
                        }
                        if (Mopub != 0) {
                            pKCS12PBMAC1KeyStoreSpi.certs.put(Mopub, GenerateCertificate);
                        }
                    } else if (pKCS12PBMAC1KeyStoreSpi.keyCerts.isEmpty()) {
                        byte[] bArrCrashlytics3 = AbstractC14024l.crashlytics(pKCS12PBMAC1KeyStoreSpi.createSubjectKeyId(GenerateCertificate.getPublicKey()).f14309l);
                        ...
                        pKCS12PBMAC1KeyStoreSpi.keyCerts.put(str, GenerateCertificate);
                        IgnoresCaseHashtable ignoresCaseHashtable = pKCS12PBMAC1KeyStoreSpi.keys;
    ...
    public void engineStore(KeyStore.LoadStoreParameter loadStoreParameter) throws IOException {
        ...
        if (c7809l.getMacAlgorithm().f20787l.ad(InterfaceC0543l.f1925while)) {
            C10198l macAlgorithm = c7809l.getMacAlgorithm();
            this.macAlgorithm = macAlgorithm;
            C10198l c10198l = C5774l.vip(macAlgorithm.f20786l).f12174l;
            if (!c10198l.f20787l.ad(InterfaceC0543l.f1923transient)) {
                C11467l.smaato(c10198l.f20787l.inmobi(), "No support for KDF parameter of type ");
                return;
            }
        }
    ...
    public class CertId {
        ...
        public CertId(PublicKey publicKey) {
            this.id = AbstractC14024l.crashlytics(PKCS12PBMAC1KeyStoreSpi.this.createSubjectKeyId(publicKey).f14309l);
        }
    ...
    public byte[] wrapKey(C10198l c10198l, Key key, char[] cArr) throws IOException {
        try {
            return createCipher(3, cArr, c10198l).wrap(key);
        } catch (Exception e) {
            C18262l.metrica(AbstractC5020l.ads(e, new StringBuilder("exception encrypting data - ")));
            return null;
        }
    ...
    public void engineStore(OutputStream outputStream, char[] cArr) throws IOException {
        doStore(outputStream, cArr, true, true);
    }
