...
public class KeyPairGeneratorSpi extends KeyPairGenerator {
    ...
    public KeyPair generateKeyPair() {
        ...
        if (obj instanceof C12726l) {
            ...
            BCECGOST3410_2012PublicKey bCECGOST3410_2012PublicKey = new BCECGOST3410_2012PublicKey(this.algorithm, c4148l, c12726l);
            return new KeyPair(bCECGOST3410_2012PublicKey, new BCECGOST3410_2012PrivateKey(this.algorithm, c8374l, bCECGOST3410_2012PublicKey, c12726l));
        }
        if (obj == null) {
            return new KeyPair(new BCECGOST3410_2012PublicKey(this.algorithm, c4148l), new BCECGOST3410_2012PrivateKey(this.algorithm, c8374l));
        }
        ECParameterSpec eCParameterSpec = (ECParameterSpec) obj;
        BCECGOST3410_2012PublicKey bCECGOST3410_2012PublicKey2 = new BCECGOST3410_2012PublicKey(this.algorithm, c4148l, eCParameterSpec);
        return new KeyPair(bCECGOST3410_2012PublicKey2, new BCECGOST3410_2012PrivateKey(this.algorithm, c8374l, bCECGOST3410_2012PublicKey2, eCParameterSpec));
    }
    ...
    public void initialize(AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) throws InvalidAlgorithmParameterException {
        ...
        if (z || (algorithmParameterSpec instanceof C6051l)) {
            ...
            Cfor cforBilling = AbstractC11696l.billing(name);
            if (cforBilling.ad(InterfaceC18410l.smaato) || cforBilling.ad(InterfaceC18410l.remoteconfig) || cforBilling.ad(InterfaceC18410l.vip)) {
                init(new C0429l(AbstractC11696l.billing(name), null), secureRandom);
                return;
            } else {
                init(new C0429l(name), secureRandom);
                return;
            }
        }
