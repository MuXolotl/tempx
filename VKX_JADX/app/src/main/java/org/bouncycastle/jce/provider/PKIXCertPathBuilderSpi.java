            ...
            try {
                if (CertPathValidatorUtilities.isIssuerTrustAnchor(x509Certificate, c5384l.f11526l, c5384l.f11525l.getSigProvider())) {
                    try {
                        ...
                        try {
                            PKIXCertPathValidatorResult pKIXCertPathValidatorResult = (PKIXCertPathValidatorResult) pKIXCertPathValidatorSpi.engineValidate(certPathEngineGenerateCertPath, c14155l);
