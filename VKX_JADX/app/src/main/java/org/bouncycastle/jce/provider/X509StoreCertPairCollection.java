...
public class X509StoreCertPairCollection extends AbstractC9690l {
    ...
    public void engineInit(InterfaceC15681l interfaceC15681l) {
        throw new IllegalArgumentException("Initialization parameters must be an instance of " + AbstractC12704l.class.getName() + ".");
    }
}
