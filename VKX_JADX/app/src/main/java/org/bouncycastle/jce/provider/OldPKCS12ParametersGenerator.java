...
class OldPKCS12ParametersGenerator extends AbstractC11186l {
    ...
    public OldPKCS12ParametersGenerator(InterfaceC16922l interfaceC16922l) {
        this.digest = interfaceC16922l;
        if (interfaceC16922l instanceof C3077l) {
            this.u = 16;
        } else {
            if (!(interfaceC16922l instanceof C0655l) && !(interfaceC16922l instanceof C4871l)) {
                C4875l.smaato(interfaceC16922l.getAlgorithmName(), " unsupported", "Digest ");
                throw null;
            }
            this.u = 20;
        }
    ...
    private byte[] generateDerivedKey(int i, int i2) {
        ...
        while (i15 <= i14) {
            ...
            if (i15 == i14) {
                int i22 = (i15 - 1) * i21;
                i3 = 0;
                System.arraycopy(bArr11, 0, bArr4, i22, i2 - i22);
            } else {
                i3 = 0;
                System.arraycopy(bArr11, 0, bArr4, (i15 - 1) * i21, i16);
            }
            i15++;
            i5 = i3;
            i7 = 1;
    ...
    public InterfaceC9719l generateDerivedMacParameters(int i) {
        int i2 = i / 8;
        return new C13886l(generateDerivedKey(3, i2), 0, i2);
    }

    @Override // defpackage.AbstractC11186l
    public InterfaceC9719l generateDerivedParameters(int i, int i2) {
        int i3 = i / 8;
        int i4 = i2 / 8;
    ...
    @Override // defpackage.AbstractC11186l
    public InterfaceC9719l generateDerivedParameters(int i) {
        int i2 = i / 8;
