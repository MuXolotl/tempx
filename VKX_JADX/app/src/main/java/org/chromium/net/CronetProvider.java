...
public abstract class CronetProvider {
    ...
    public String toString() {
        ...
        StringBuilder sbLicense = AbstractC14814l.license("[class=", name, ", name=", name2, ", version=");
        sbLicense.append(version);
        sbLicense.append(", enabled=");
        sbLicense.append(zIsEnabled);
        sbLicense.append("]");
