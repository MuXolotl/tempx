    ...
    public static class Builder {
        ...
        public static int compareVersions(String str, String str2) {
            if (str == null || str2 == null) {
                C8339l.metrica("The input values cannot be null");
                return 0;
            }
            ...
            for (int i = 0; i < strArrSplit.length && i < strArrSplit2.length; i++) {
                try {
                    ...
                    throw new IllegalArgumentException(AbstractC14814l.adcel("Unable to convert version segments into integers: ", strArrSplit[i], " & ", strArrSplit2[i]), e);
                }
            }
        ...
        public static List<CronetProvider> getEnabledCronetProviders(Context context, List<CronetProvider> list) {
            if (list.isEmpty()) {
                C18073l.license("Unable to find any Cronet provider. Have you included all necessary jars?");
                return null;
            }
            ...
            if (list.isEmpty()) {
                C18073l.license("All available Cronet providers are disabled. A provider should be enabled before it can be used.");
                return null;
            }
            Collections.sort(list, new yandex());
            return list;
        }
