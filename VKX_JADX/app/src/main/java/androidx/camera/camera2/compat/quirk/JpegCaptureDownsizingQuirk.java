...
public final class JpegCaptureDownsizingQuirk implements SoftwareJpegEncodingPreferredQuirk {
    public static final JpegCaptureDownsizingQuirk yandex = new JpegCaptureDownsizingQuirk();
    public static final Set loadAd = Collections.singleton("redmi note 8 pro");
}
