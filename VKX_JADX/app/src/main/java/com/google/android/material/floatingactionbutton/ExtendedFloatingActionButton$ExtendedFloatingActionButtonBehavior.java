...
public class ExtendedFloatingActionButton$ExtendedFloatingActionButtonBehavior<T> extends AbstractC8012l {
    public ExtendedFloatingActionButton$ExtendedFloatingActionButtonBehavior(Context context, AttributeSet attributeSet) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, AbstractC4548l.subs);
    ...
    @Override // defpackage.AbstractC8012l
    public final /* synthetic */ boolean yandex(View view) {
        throw new ClassCastException();
    }
