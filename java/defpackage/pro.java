...
public final class pro implements InterfaceC10952l {
    ...
    public static byte amazon(byte b) {
        return f36542l[b & 255];
    }

    public static byte billing(byte b) {
        return f36543l[b & 255];
    }

    public static byte crashlytics(byte b) {
        return f36539l[b & 255];
    }

    public static void loadAd(byte[] bArr, byte[] bArr2) {
        subs(bArr, bArr2);
        bArr[0] = crashlytics(bArr[0]);
        bArr[1] = amazon(bArr[1]);
        bArr[2] = purchase(bArr[2]);
        bArr[3] = billing(bArr[3]);
        bArr[4] = crashlytics(bArr[4]);
        bArr[5] = amazon(bArr[5]);
        bArr[6] = purchase(bArr[6]);
        bArr[7] = billing(bArr[7]);
        bArr[8] = crashlytics(bArr[8]);
        bArr[9] = amazon(bArr[9]);
        bArr[10] = purchase(bArr[10]);
        bArr[11] = billing(bArr[11]);
        bArr[12] = crashlytics(bArr[12]);
        bArr[13] = amazon(bArr[13]);
        bArr[14] = purchase(bArr[14]);
        bArr[15] = billing(bArr[15]);
        yandex(bArr);
    }

    public static void mopub(byte[] bArr) {
        bArr[0] = purchase(bArr[0]);
        bArr[1] = billing(bArr[1]);
        bArr[2] = crashlytics(bArr[2]);
        bArr[3] = amazon(bArr[3]);
        bArr[4] = purchase(bArr[4]);
        bArr[5] = billing(bArr[5]);
        bArr[6] = crashlytics(bArr[6]);
        bArr[7] = amazon(bArr[7]);
        bArr[8] = purchase(bArr[8]);
        bArr[9] = billing(bArr[9]);
        bArr[10] = crashlytics(bArr[10]);
        bArr[11] = amazon(bArr[11]);
        bArr[12] = purchase(bArr[12]);
        bArr[13] = billing(bArr[13]);
        bArr[14] = crashlytics(bArr[14]);
        bArr[15] = amazon(bArr[15]);
    }

    public static byte purchase(byte b) {
        return f36541l[b & 255];
    }
    ...
    public final void init(boolean z, InterfaceC9719l interfaceC9719l) {
        if (!(interfaceC9719l instanceof C13886l)) {
            C8339l.metrica(AbstractC5020l.subscription("invalid parameter passed to ARIA init - ", interfaceC9719l));
            return;
        }
        ...
        admob(bArr12[0], 19, bArr8, bArr9);
        admob(bArr12[1], 19, bArr9, bArr10);
        admob(bArr12[2], 19, bArr10, bArr11);
        admob(bArr12[3], 19, bArr11, bArr8);
        admob(bArr12[4], 31, bArr8, bArr9);
        admob(bArr12[5], 31, bArr9, bArr10);
        admob(bArr12[6], 31, bArr10, bArr11);
        admob(bArr12[7], 31, bArr11, bArr8);
        admob(bArr12[8], 67, bArr8, bArr9);
        admob(bArr12[9], 67, bArr9, bArr10);
        admob(bArr12[10], 67, bArr10, bArr11);
        admob(bArr12[11], 67, bArr11, bArr8);
        admob(bArr12[12], 97, bArr8, bArr9);
        if (i4 > 12) {
            admob(bArr12[13], 97, bArr9, bArr10);
            admob(bArr12[14], 97, bArr10, bArr11);
            if (i4 > 14) {
                admob(bArr12[15], 97, bArr11, bArr8);
                admob(bArr12[16], 109, bArr8, bArr9);
            }
        }
        if (!z) {
    ...
    public final int tapsense(int i, int i2, byte[] bArr, byte[] bArr2) {
        if (this.f36544l == null) {
            C8339l.smaato("ARIA engine not initialised");
            return 0;
        }
        if (i > bArr.length - 16) {
        ...
        int length = this.f36544l.length - 3;
        int i3 = 0;
        while (true) {
            byte[][] bArr4 = this.f36544l;
            if (i3 >= length) {
                loadAd(bArr3, bArr4[i3]);
                subs(bArr3, this.f36544l[i3 + 1]);
                mopub(bArr3);
                subs(bArr3, this.f36544l[i3 + 2]);
