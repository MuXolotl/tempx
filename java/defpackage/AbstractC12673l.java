...
/* JADX INFO: renamed from: lّ٘۠, reason: invalid class name and case insensitive filesystem */
/* JADX INFO: compiled from: r8-map-id-7761d6fd52750600b6eeb3da7b88ede05d5cd0fcaae415e0ed7a2830c95bc1fb */
/* JADX INFO: loaded from: classes3.dex */
public abstract class AbstractC12673l extends AbstractC18248l {
    public static Float metrica(String str) {
        try {
            if (remoteconfig(str)) {
    ...
    public static final boolean remoteconfig(String str) {
        char c;
        boolean z;
        boolean z2;
        int i;
            ...
            if (i8 > length) {
                ...
                if (str.charAt(i8) == '.') {
                    ...
                    if (!z7 || z3) {
                        ...
                        i2 = (str2 != null && AbstractC12024l.m3333native(str, str2, i, false) == i) ? length + 1 : -1;
                    }
                } else {
                    i = i8;
                }
        ...
        if (iCharAt != (z2 ? 112 : EnergyProfile.EVCONNECTOR_TYPE_OTHER)) {
    ...
    public static Double vip(String str) {
        try {
            if (remoteconfig(str)) {
