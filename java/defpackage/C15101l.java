...
/* JADX INFO: renamed from: lٔۗٞ, reason: invalid class name and case insensitive filesystem */
/* JADX INFO: compiled from: r8-map-id-7761d6fd52750600b6eeb3da7b88ede05d5cd0fcaae415e0ed7a2830c95bc1fb */
/* JADX INFO: loaded from: classes.dex */
public final class C15101l {
    public final float[] loadAd;
    public char yandex;

    public C15101l(C15101l c15101l) {
        this.yandex = c15101l.yandex;
        float[] fArr = c15101l.loadAd;
        this.loadAd = AbstractC15300l.purchase(fArr, fArr.length);
    }

    public static void yandex(Path path, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean z, boolean z2) {
        double d;
        double d2;
        ...
        if (d17 < 0.0d) {
            ...
            yandex(path, f, f2, f3, f4, f5 * fSqrt, fSqrt * f6, f7, z, z2);
            return;
        }
    ...
    public C15101l(char c, float[] fArr) {
        this.yandex = c;
        this.loadAd = fArr;
    }
}
