...
/* JADX INFO: renamed from: lِٔٙ, reason: invalid class name and case insensitive filesystem */
/* JADX INFO: compiled from: r8-map-id-7761d6fd52750600b6eeb3da7b88ede05d5cd0fcaae415e0ed7a2830c95bc1fb */
/* JADX INFO: loaded from: classes3.dex */
public final class C11843l implements InterfaceC17211l, InterfaceC7669l {
    public final C4384l yandex;

    public C11843l(C4384l c4384l) {
        this.yandex = c4384l;
    }

    @Override // defpackage.InterfaceC7669l
    public final void admob(int i) {
        vip(new C9695l(new C1355l(i)));
    }
    ...
    public final void firebase(int i) {
        vip(new C9695l(new C6214l(i)));
    }

    @Override // defpackage.InterfaceC7669l
    public final void isPro(int i) {
        vip(new C9695l(new C7479l(i)));
    }

    @Override // defpackage.InterfaceC7669l
    public final void mopub() {
        vip(new C9695l(new C3099l()));
    }

    @Override // defpackage.InterfaceC17211l
    public final InterfaceC17211l smaato() {
        return new C11843l(new C4384l());
    }
