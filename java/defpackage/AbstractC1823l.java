...
/* JADX INFO: renamed from: lْٟؓ, reason: invalid class name and case insensitive filesystem */
...
public abstract class AbstractC1823l {
    ...
    jadx.core.utils.exceptions.JadxRuntimeException: Type update failed for variable: r10v0 ??, new type: boolean
    ...
    static {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.AbstractC1823l.<clinit>():void");
    }

    public static void adcel(Class cls) {
        if (amazon) {
            crashlytics.yandex.arrayIndexScale(cls);
        }
    }

    public static void admob(long j, long j2, Object obj) {
    ...
    public static void firebase(byte[] bArr, long j, byte b) {
        crashlytics.loadAd(bArr, purchase + j, b);
    }

    public static void isPro(long j, Object obj, Object obj2) {
        crashlytics.yandex.putObject(obj, j, obj2);
    }

    public static void loadAd(Object obj, long j, byte b) {
        Unsafe unsafe = crashlytics.yandex;
        long j2 = (-4) & j;
    ...
    public static long mopub(long j, Object obj) {
    ...
    public static Unsafe smaato() {
        Unsafe unsafe;
        try {
            unsafe = (Unsafe) AccessController.doPrivileged(new C5398l());
        } catch (Throwable unused) {
            unsafe = null;
        }
        if (unsafe == null) {
        ...
        try {
            ...
            Logger.getLogger(AbstractC1823l.class.getName()).logp(Level.WARNING, "com.google.protobuf.UnsafeUtil", "getUnsafe", "As part of the planned removal, sun.misc.Unsafe is available in the current environment but configured to throw on use. Protobuf will continue without using it, but with slightly reduced performance. --sun-misc-unsafe-memory-access=allow is likely available to opt back in if desired. A later Protobuf version release will stop using sun.misc.Unsafe entirely.");
            return null;
        }
    }
    ...
    public static Object subs(long j, Object obj) {
