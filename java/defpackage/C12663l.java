...
/* JADX INFO: renamed from: lّ٘ؑ, reason: invalid class name and case insensitive filesystem */
/* JADX INFO: loaded from: classes3.dex */
public final class C12663l implements InterfaceC9273l, InterfaceC11512l {
    ...
    public final EnumC2441l f24942l;
    ...
    public C12663l(int i) {
        ...
        this.f24947l = jArr;
        jArr[0] = i4;
        this.f24939l = new long[i3];
        this.f24940l = new long[i3];
        this.f24948l = new byte[i4];
        AbstractC3586l.amazon(this);
        AbstractC8776l.yandex();
    }

    public static long admob(int i, long j) {
        return (j << (-i)) | (j >>> i);
    }

    public final void amazon(long[] jArr) {
        for (int i = 0; i < this.f24944l; i++) {
            long j = i;
            for (int i2 = 0; i2 < this.f24945l; i2++) {
                jArr[i2] = jArr[i2] ^ j;
                j += 16;
            }
            subs(jArr);
    ...
    public final void billing(long[] jArr) {
        for (int i = 0; i < this.f24945l; i++) {
            long j = jArr[i];
            long j2 = ((9187201950435737471L & j) << 1) ^ (((j & (-9187201950435737472L)) >>> 7) * 29);
            long jAdmob = admob(8, j) ^ j;
            long jAdmob2 = (jAdmob ^ admob(16, jAdmob)) ^ admob(48, j);
            long j3 = (j ^ jAdmob2) ^ j2;
            jArr[i] = ((admob(32, (((j3 & 4629771061636907072L) >>> 6) * 29) ^ (((((-9187201950435737472L) & j3) >>> 6) * 29) ^ ((4557430888798830399L & j3) << 2))) ^ jAdmob2) ^ admob(40, j2)) ^ admob(48, j2);
        }
    }
    ...
    public final int doFinal(byte[] bArr, int i) {
        ...
        int i3;
        int i4 = this.f24943l;
        byte[] bArr2 = this.f24948l;
        int i5 = i4 + 1;
        this.f24943l = i5;
        bArr2[i4] = -128;
        int i6 = this.f24938l - 12;
        int i7 = 0;
        if (i5 > i6) {
            while (true) {
                int i8 = this.f24943l;
                ...
                byte[] bArr3 = this.f24948l;
                this.f24943l = i8 + 1;
                bArr3[i8] = 0;
            }
            this.f24943l = 0;
            mopub(0, this.f24948l);
        }
        while (true) {
            i2 = this.f24943l;
            if (i2 >= i6) {
            ...
            byte[] bArr4 = this.f24948l;
            this.f24943l = i2 + 1;
            bArr4[i2] = 0;
        }
        long j = (((this.f24946l & 4294967295L) * ((long) this.f24938l)) + ((long) i4)) << 3;
        AbstractC10000l.smaato((int) j, i2, this.f24948l);
        int i9 = this.f24943l + 4;
        this.f24943l = i9;
        AbstractC10000l.pro((j >>> 32) + (((this.f24946l >>> 32) * ((long) this.f24938l)) << 3), this.f24948l, i9);
        mopub(0, this.f24948l);
        System.arraycopy(this.f24947l, 0, this.f24939l, 0, this.f24945l);
        amazon(this.f24939l);
        while (true) {
            i3 = this.f24945l;
            if (i7 >= i3) {
            ...
            long[] jArr = this.f24947l;
            jArr[i7] = jArr[i7] ^ this.f24939l[i7];
            i7++;
        }
        for (int i10 = i3 - (this.f24941l >>> 3); i10 < this.f24945l; i10++) {
            AbstractC10000l.pro(this.f24947l[i10], bArr, i);
            i += 8;
        }
        reset();
        return this.f24941l;
    ...
    public final void isPro(long[] jArr) {
        for (int i = 0; i < this.f24945l; i++) {
            long j = jArr[i];
            int i2 = (int) j;
            int i3 = (int) (j >>> 32);
            ...
            byte[] bArr4 = f24935l;
            int i4 = (b & 255) | ((b2 & 255) << 8) | ((b3 & 255) << 16) | (bArr4[i2 >>> 24] << 24);
            byte b4 = bArr[i3 & 255];
            byte b5 = bArr2[(i3 >>> 8) & 255];
            byte b6 = bArr3[(i3 >>> 16) & 255];
            jArr[i] = (((long) i4) & 4294967295L) | (((long) ((bArr4[i3 >>> 24] << 24) | (((b4 & 255) | ((b5 & 255) << 8)) | ((b6 & 255) << 16)))) << 32);
        }
    }

    @Override // defpackage.InterfaceC11512l
    public final void loadAd(InterfaceC11512l interfaceC11512l) {
        purchase((C12663l) interfaceC11512l);
    }

    public final void mopub(int i, byte[] bArr) {
        for (int i2 = 0; i2 < this.f24945l; i2++) {
            long jSubscription = AbstractC10000l.subscription(i, bArr);
            i += 8;
            this.f24939l[i2] = this.f24947l[i2] ^ jSubscription;
            this.f24940l[i2] = jSubscription;
        }
        amazon(this.f24939l);
        long[] jArr = this.f24940l;
        for (int i3 = 0; i3 < this.f24944l; i3++) {
            long j = (((long) (((this.f24945l - 1) << 4) ^ i3)) << 56) | 67818912035696883L;
            for (int i4 = 0; i4 < this.f24945l; i4++) {
                jArr[i4] = jArr[i4] + j;
        ...
        for (int i5 = 0; i5 < this.f24945l; i5++) {
            long[] jArr2 = this.f24947l;
            jArr2[i5] = jArr2[i5] ^ (this.f24939l[i5] ^ this.f24940l[i5]);
        }
    }

    public final void purchase(C12663l c12663l) {
        this.f24941l = c12663l.f24941l;
        this.f24938l = c12663l.f24938l;
        this.f24944l = c12663l.f24944l;
        int i = this.f24945l;
        if (i <= 0 || i != c12663l.f24945l) {
            this.f24945l = c12663l.f24945l;
            long[] jArr = c12663l.f24947l;
            this.f24947l = jArr == null ? null : (long[]) jArr.clone();
            int i2 = this.f24945l;
            this.f24939l = new long[i2];
            this.f24940l = new long[i2];
            this.f24948l = AbstractC14024l.crashlytics(c12663l.f24948l);
        } else {
            System.arraycopy(c12663l.f24947l, 0, this.f24947l, 0, i);
            System.arraycopy(c12663l.f24948l, 0, this.f24948l, 0, this.f24938l);
        }
        this.f24946l = c12663l.f24946l;
        this.f24943l = c12663l.f24943l;
    }

    @Override // defpackage.InterfaceC16922l
    public final void reset() {
        Arrays.fill(this.f24947l, 0L);
        this.f24947l[0] = this.f24938l;
        this.f24946l = 0L;
        this.f24943l = 0;
    }

    public final void subs(long[] jArr) {
        int i = this.f24945l;
        if (i == 8) {
            long j = jArr[0];
            long j2 = jArr[1];
        ...
        if (i != 16) {
            C8339l.smaato("unsupported state size: only 512/1024 are allowed");
            return;
        }
        long j41 = jArr[0];
        long j42 = jArr[1];
    ...
    public final void update(byte[] bArr, int i, int i2) {
        while (this.f24943l != 0 && i2 > 0) {
            update(bArr[i]);
            i2--;
            i++;
        }
        if (i2 > 0) {
            while (i2 >= this.f24938l) {
                mopub(i, bArr);
                int i3 = this.f24938l;
                i += i3;
                i2 -= i3;
    ...
    public final InterfaceC11512l yandex() {
        return new C12663l(this);
    }

    @Override // defpackage.InterfaceC16922l
    public final void update(byte b) {
        byte[] bArr = this.f24948l;
        int i = this.f24943l;
        int i2 = i + 1;
        this.f24943l = i2;
        bArr[i] = b;
    ...
    public C12663l(C12663l c12663l) {
        this.f24942l = c12663l.f24942l;
        purchase(c12663l);
        AbstractC3586l.amazon(this);
        AbstractC8776l.yandex();
    }
