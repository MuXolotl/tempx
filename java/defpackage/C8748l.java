...
/* JADX INFO: renamed from: lٌْٕ, reason: invalid class name and case insensitive filesystem */
/* JADX INFO: compiled from: r8-map-id-7761d6fd52750600b6eeb3da7b88ede05d5cd0fcaae415e0ed7a2830c95bc1fb */
/* JADX INFO: loaded from: classes.dex */
public final class C8748l extends AbstractC10581l {

    /* JADX INFO: renamed from: lؒٝ, reason: contains not printable characters */
    public final String f18009l;

    /* JADX INFO: renamed from: lُؗٝ, reason: contains not printable characters */
    public final InterfaceC6942l f18010l;

    /* JADX INFO: renamed from: l٘ٞؒ, reason: contains not printable characters */
    public final C1008l f18011l;

    public C8748l(String str) {
        this.f18009l = str;
        C1008l c1008lYandex = AbstractC11190l.yandex(str);
        this.f18011l = c1008lYandex;
        this.f18010l = AbstractC0622l.metrica(new C1954l(c1008lYandex, 1), AbstractC11463l.yandex);
    }

    /* JADX INFO: renamed from: protected, reason: not valid java name */
    public static final void m2422protected(C8748l c8748l, CachedTrack cachedTrack, InterfaceC13238l interfaceC13238l) {
        AppActivity appActivity = (AppActivity) c8748l.isVip();
    ...
    public final void m2423break(CachedTrack cachedTrack, Function0 function0, Function0 function1, C6956l c6956l, int i) {
        c6956l.m2133new(1090755532);
        ...
        if (c6956l.m2127for(i2 & 1, (i2 & 1171) != 1170)) {
            int i3 = 8;
            AbstractC0133l.amazon(AbstractC14566l.amazon(-824293670, new C3091l(this, cachedTrack, i3), c6956l), AbstractC14566l.amazon(886984697, new C11548l(cachedTrack, 7), c6956l), AbstractC3605l.remoteconfig(AbstractC0080l.amazon(AbstractC9151l.amazon(C4346l.f8873l, null, function1, null, function0, 239), 1.0f), 16.0f, 6.0f), AbstractC14566l.amazon(14574135, new C11548l(cachedTrack, i3), c6956l), c6956l, 3126, 0);
        } else {
            c6956l.m2124else();
        }
        C4224l c4224lAds = c6956l.ads();
        if (c4224lAds != null) {
            c4224lAds.amazon = new C2104l(this, cachedTrack, function0, function1, i, 23);
        }
    }

    /* JADX INFO: renamed from: finally, reason: not valid java name */
    public final void m2424finally(String str, String str2, C6956l c6956l, int i, int i2) {
        String str3;
        int i3;
        String str4;
        boolean z;
        c6956l.m2133new(257936987);
        ...
        if (c6956l.m2127for(i6 & 1, (i6 & 19) != 18)) {
            ...
            if (str5 != null) {
                c6956l2.m2123default(911302644);
                String str6 = str5;
                ...
                str4 = str5;
                z = false;
                c6956l2.m2123default(897233635);
            }
            c6956l2.startapp(z);
        ...
        C4224l c4224lAds = c6956l.ads();
        if (c4224lAds != null) {
            c4224lAds.amazon = new C4810l(i, i2, 23, this, str, str4);
        }
    }
    ...
    public final void mo271new(C6956l c6956l, int i) {
        c6956l.m2133new(2009944829);
        int i2 = i | (c6956l.admob(this) ? 4 : 2);
        int i3 = 0;
        if (c6956l.m2127for(i2 & 1, (i2 & 3) != 2)) {
            C1008l c1008l = this.f18011l;
            C5268l c5268l = this.f34614l;
            AbstractC15497l.loadAd(null, AbstractC14566l.amazon(2088216001, new C9470l(this, AbstractC3700l.purchase(c1008l, c5268l, c6956l), i3), c6956l), null, null, null, 0, 0L, 0L, ((C15700l) c6956l.isPro(AbstractC18678l.yandex)).amazon(c6956l), AbstractC14566l.amazon(1871718156, new C0673l(this, AbstractC3700l.crashlytics(this.f18010l, new C16187l(), c5268l, c6956l, 0, 12), i3), c6956l), c6956l, 805306416, 253);
        } else {
            c6956l.m2124else();
        }
        C4224l c4224lAds = c6956l.ads();
        if (c4224lAds != null) {
            c4224lAds.amazon = new C5780l(this, i, 0);
        }
    }

    /* JADX INFO: renamed from: public, reason: not valid java name */
    public final void m2425public(C6956l c6956l, int i) {
        C6956l c6956l2 = c6956l;
        c6956l2.m2133new(-1771692608);
        int i2 = i & 1;
        ...
        if (c4224lAds != null) {
            c4224lAds.amazon = new C5780l(this, i, 3);
        }
    }

    /* JADX INFO: renamed from: this, reason: not valid java name */
    public final void m2426this(CachedPlaylist cachedPlaylist, C6956l c6956l, int i) {
        int i2;
        C6956l c6956l2 = c6956l;
        c6956l2.m2133new(-290279759);
        int i3 = i | (c6956l2.admob(cachedPlaylist) ? 4 : 2) | (c6956l2.admob(this) ? 32 : 16);
        if (c6956l2.m2127for(i3 & 1, (i3 & 19) != 18)) {
            ...
            if (zAdmob || objM2132native == c13863l) {
                objM2132native = new C8652l(this, cachedPlaylist, 20);
        ...
        C4224l c4224lAds = c6956l2.ads();
        if (c4224lAds != null) {
            c4224lAds.amazon = new C2736l(this, cachedPlaylist, i, i2);
        }
    }

    /* JADX INFO: renamed from: transient, reason: not valid java name */
    public final void m2427transient(String str, Function1 function1, Function1 function2, InterfaceC17242l interfaceC17242l, boolean z, Function2 function3, Function2 function4, C1351l c1351l, C2403l c2403l, C6956l c6956l, int i) {
        boolean z2;
        C2403l c2403l2;
        C2403l c2403l3;
        boolean z3;
        c6956l.m2133new(909874670);
        ...
        if (c6956l.m2127for(i2 & 1, (306783379 & i2) != 306783378)) {
            ...
            if (zAdmob || objM2132native3 == obj) {
                objM2132native3 = new C17313l(interfaceC6497l, function2, str, 1);
                c6956l.m2147try(objM2132native3);
            }
            boolean z4 = z3;
            AbstractC16363l.amazon(str, function1, interfaceC17242lBilling, z4, c11090lBilling, c3790l, new C6973l(null, (Function1) objM2132native3, 47), true, 0, 0, null, null, c2403l4, c8990l, AbstractC14566l.amazon(-910097813, new C13479l(str, z4, c2403l4, function3, function4, c1351l, 1), c6956l), c6956l, i4 | 102236160 | (i2 & 112) | 3072, 199680, 7696);
            Unit unit = Unit.INSTANCE;
            Object objM2132native4 = c6956l.m2132native();
            if (objM2132native4 == obj) {
                objM2132native4 = new C0915l(c6523l, null, 1);
        ...
        C4224l c4224lAds = c6956l.ads();
        if (c4224lAds != null) {
            c4224lAds.amazon = new C14674l(this, str, function1, function2, interfaceC17242l, z2, function3, function4, c1351l, c2403l2, i, 3);
        }
    }

    /* JADX INFO: renamed from: try, reason: not valid java name */
    public final void m2428try(InterfaceC13238l interfaceC13238l, C6956l c6956l, int i) {
        c6956l.m2133new(-2028090815);
        ...
        if (c6956l.m2127for(i2 & 1, (i2 & 19) != 18)) {
            ...
            if (zAdmob || objM2132native == C1867l.yandex) {
                objM2132native = new C10207l(interfaceC13238l, this, 13);
        ...
        C4224l c4224lAds = c6956l.ads();
        if (c4224lAds != null) {
            c4224lAds.amazon = new C2736l(this, interfaceC13238l, i, i3);
        }
    }
}
