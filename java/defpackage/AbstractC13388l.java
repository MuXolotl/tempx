...
/* JADX INFO: renamed from: lَْٕ, reason: invalid class name and case insensitive filesystem */
/* JADX INFO: compiled from: r8-map-id-7761d6fd52750600b6eeb3da7b88ede05d5cd0fcaae415e0ed7a2830c95bc1fb */
/* JADX INFO: loaded from: classes3.dex */
public abstract class AbstractC13388l {
    static {
  ...
  0x0091: PHI (r4v6 byte) = (r4v5 byte), (r4v9 byte) binds: [B:41:0x008c, B:43:0x0090] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    public static String amazon(int i, int i2, byte[] bArr) throws C9893l {
        if (i2 == 0) {
            return "";
        }
        ...
        while (i < i3) {
            ...
            if (b2 >= 0) {
                ...
                if (i5 >= i3) {
                    C11586l.admob("Protocol message had invalid UTF-8.");
                    return null;
                }
                int i6 = i4 + 1;
                i += 2;
                byte b4 = bArr[i5];
                if (b2 < -62 || AbstractC15497l.startapp(b4)) {
                    C11586l.admob("Protocol message had invalid UTF-8.");
                    return null;
                }
                ...
                if (b2 < -16) {
                    ...
                    i += 3;
                    byte b6 = bArr[i8];
                    if (!AbstractC15497l.startapp(b5)) {
                        if (b2 != -32) {
                            if (b2 != -19) {
                                if (!AbstractC15497l.startapp(b6)) {
                ...
                i += 4;
                byte b9 = bArr[i9];
                if (AbstractC15497l.startapp(b7) || (((b7 + 112) + (b2 << 28)) >> 30) != 0 || AbstractC15497l.startapp(b8) || AbstractC15497l.startapp(b9)) {
                    C11586l.admob("Protocol message had invalid UTF-8.");
                    return null;
                }
    ...
    public static int crashlytics(String str, byte[] bArr, int i, int i2) {
        int i3;
        int i4;
        int length;
        int i5;
                        ...
                        if (cCharAt2 < 2048) {
                            ...
                            if (cCharAt2 >= 55296 && cCharAt2 <= 57343) {
                                if (Character.codePointAt(str, i2) < 65536) {
                                    throw new C12358l(C16292l.yandex(length2, i2, (byte) 32, "Unpaired surrogate at index ", " of "));
                                }
                                i2++;
                            }
                        }
    ...
    public static boolean yandex(int i, int i2, byte[] bArr) {
        while (i < i2 && bArr[i] >= 0) {
            i++;
        }
        if (i >= i2) {
