...
public final class Catalog2Block_RadioStationsBlockJsonAdapter extends AbstractC7188l {
    ...
    public final C0458l yandex = C0458l.m547strictfp("id", "layout", "actions", "next_from", "listen_events", "radio_stations_ids");

    public Catalog2Block_RadioStationsBlockJsonAdapter(C12952l c12952l) {
        ...
        this.mopub = c12952l.loadAd(AbstractC15639l.mopub(List.class, Integer.class), c5746l, "radio_stations_ids");
    }
    ...
    public final void billing(C3631l c3631l, Object obj) {
        ...
        Catalog2Block.RadioStationsBlock radioStationsBlock = (Catalog2Block.RadioStationsBlock) obj;
        c3631l.mopub();
        c3631l.isVip("id");
        this.loadAd.billing(c3631l, radioStationsBlock.yandex);
        c3631l.isVip("layout");
        this.crashlytics.billing(c3631l, radioStationsBlock.loadAd);
        c3631l.isVip("actions");
        this.amazon.billing(c3631l, radioStationsBlock.crashlytics);
        c3631l.isVip("next_from");
        this.purchase.billing(c3631l, radioStationsBlock.amazon);
        c3631l.isVip("listen_events");
        this.billing.billing(c3631l, radioStationsBlock.purchase);
        c3631l.isVip("radio_stations_ids");
        this.mopub.billing(c3631l, radioStationsBlock.billing);
        c3631l.adcel();
    }
    ...
    public final Object loadAd(C0396l c0396l) throws C8413l, EOFException {
        ...
        if (i == -61) {
            return new Catalog2Block.RadioStationsBlock(str2, str3, list, list2, list3, catalog2Layout);
        }
        if ((i & 4) != 0) {
            list = null;
        }
        ...
        return new Catalog2Block.RadioStationsBlock(str2, str, list, list2, list3, catalog2Layout);
    }

    public final String toString() {
        return "GeneratedJsonAdapter(Catalog2Block.RadioStationsBlock)";
    }
}
