...
public final class Catalog2Block_RecommendedPlaylistsBlockJsonAdapter extends AbstractC7188l {
    public final AbstractC7188l amazon;
    public final AbstractC7188l billing;
    public final AbstractC7188l crashlytics;
    public final AbstractC7188l loadAd;
    public final AbstractC7188l purchase;
    public final C0458l yandex = C0458l.m547strictfp("id", "layout", "actions", "listen_events", "next_from", "audios_ids", "playlists_ids");

    public Catalog2Block_RecommendedPlaylistsBlockJsonAdapter(C12952l c12952l) {
    ...
    public final void billing(C3631l c3631l, Object obj) {
        ...
        Catalog2Block.RecommendedPlaylistsBlock recommendedPlaylistsBlock = (Catalog2Block.RecommendedPlaylistsBlock) obj;
        c3631l.mopub();
        c3631l.isVip("id");
        this.loadAd.billing(c3631l, recommendedPlaylistsBlock.yandex);
        c3631l.isVip("layout");
        this.crashlytics.billing(c3631l, recommendedPlaylistsBlock.loadAd);
        c3631l.isVip("actions");
        this.amazon.billing(c3631l, recommendedPlaylistsBlock.crashlytics);
        c3631l.isVip("listen_events");
        List list = recommendedPlaylistsBlock.amazon;
        AbstractC7188l abstractC7188l = this.purchase;
        abstractC7188l.billing(c3631l, list);
        c3631l.isVip("next_from");
        this.billing.billing(c3631l, recommendedPlaylistsBlock.purchase);
        c3631l.isVip("audios_ids");
        abstractC7188l.billing(c3631l, recommendedPlaylistsBlock.billing);
        c3631l.isVip("playlists_ids");
        abstractC7188l.billing(c3631l, recommendedPlaylistsBlock.mopub);
        c3631l.adcel();
    }
    ...
    public final Object loadAd(C0396l c0396l) throws C8413l, EOFException {
        ...
        List list5 = (List) objLoadAd5;
        if (i == -125) {
            return new Catalog2Block.RecommendedPlaylistsBlock(str, str2, list2, list3, list4, list5, catalog2Layout);
        }
        if ((i & 4) != 0) {
            list2 = null;
        }
        ...
        return new Catalog2Block.RecommendedPlaylistsBlock(str, str2, list2, list, list4, list5, catalog2Layout);
    }

    public final String toString() {
        return "GeneratedJsonAdapter(Catalog2Block.RecommendedPlaylistsBlock)";
    }
}
