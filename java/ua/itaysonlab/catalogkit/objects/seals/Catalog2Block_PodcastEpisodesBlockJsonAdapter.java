...
public final class Catalog2Block_PodcastEpisodesBlockJsonAdapter extends AbstractC7188l {
    public final AbstractC7188l amazon;
    public final AbstractC7188l billing;
    public final AbstractC7188l crashlytics;
    public final AbstractC7188l loadAd;
    public final AbstractC7188l purchase;
    public final C0458l yandex = C0458l.m547strictfp("id", "layout", "actions", "next_from", "listen_events", "podcast_episodes_ids");

    public Catalog2Block_PodcastEpisodesBlockJsonAdapter(C12952l c12952l) {
    ...
    public final void billing(C3631l c3631l, Object obj) {
        ...
        Catalog2Block.PodcastEpisodesBlock podcastEpisodesBlock = (Catalog2Block.PodcastEpisodesBlock) obj;
        c3631l.mopub();
        c3631l.isVip("id");
        this.loadAd.billing(c3631l, podcastEpisodesBlock.yandex);
        c3631l.isVip("layout");
        this.crashlytics.billing(c3631l, podcastEpisodesBlock.loadAd);
        c3631l.isVip("actions");
        this.amazon.billing(c3631l, podcastEpisodesBlock.crashlytics);
        c3631l.isVip("next_from");
        this.purchase.billing(c3631l, podcastEpisodesBlock.amazon);
        c3631l.isVip("listen_events");
        List list = podcastEpisodesBlock.purchase;
        AbstractC7188l abstractC7188l = this.billing;
        abstractC7188l.billing(c3631l, list);
        c3631l.isVip("podcast_episodes_ids");
        abstractC7188l.billing(c3631l, podcastEpisodesBlock.billing);
        c3631l.adcel();
    }
    ...
    public final Object loadAd(C0396l c0396l) throws C8413l, EOFException {
        ...
        if (i == -61) {
            return new Catalog2Block.PodcastEpisodesBlock(str2, str3, list, list2, list3, catalog2Layout);
        }
        if ((i & 4) != 0) {
            list = null;
        }
        ...
        return new Catalog2Block.PodcastEpisodesBlock(str2, str, list, list2, list3, catalog2Layout);
    }

    public final String toString() {
        return "GeneratedJsonAdapter(Catalog2Block.PodcastEpisodesBlock)";
    }
}
