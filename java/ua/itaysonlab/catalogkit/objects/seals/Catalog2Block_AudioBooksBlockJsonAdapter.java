...
public final class Catalog2Block_AudioBooksBlockJsonAdapter extends AbstractC7188l {
    ...
    public final C0458l yandex = C0458l.m547strictfp("id", "layout", "actions", "next_from", "listen_events", "audio_book_ids");

    public Catalog2Block_AudioBooksBlockJsonAdapter(C12952l c12952l) {
        ...
        this.mopub = c12952l.loadAd(AbstractC15639l.mopub(List.class, Integer.class), c5746l, "audio_book_ids");
    }
    ...
    public final void billing(C3631l c3631l, Object obj) {
        ...
        Catalog2Block.AudioBooksBlock audioBooksBlock = (Catalog2Block.AudioBooksBlock) obj;
        c3631l.mopub();
        c3631l.isVip("id");
        this.loadAd.billing(c3631l, audioBooksBlock.yandex);
        c3631l.isVip("layout");
        this.crashlytics.billing(c3631l, audioBooksBlock.loadAd);
        c3631l.isVip("actions");
        this.amazon.billing(c3631l, audioBooksBlock.crashlytics);
        c3631l.isVip("next_from");
        this.purchase.billing(c3631l, audioBooksBlock.amazon);
        c3631l.isVip("listen_events");
        this.billing.billing(c3631l, audioBooksBlock.purchase);
        c3631l.isVip("audio_book_ids");
        this.mopub.billing(c3631l, audioBooksBlock.billing);
        c3631l.adcel();
    }
    ...
    public final Object loadAd(C0396l c0396l) throws C8413l, EOFException {
        ...
        if (i == -61) {
            return new Catalog2Block.AudioBooksBlock(str2, str3, list, list2, list3, catalog2Layout);
        }
        if ((i & 4) != 0) {
            list = null;
        }
        ...
        return new Catalog2Block.AudioBooksBlock(str2, str, list, list2, list3, catalog2Layout);
    }

    public final String toString() {
        return "GeneratedJsonAdapter(Catalog2Block.AudioBooksBlock)";
    }
}
