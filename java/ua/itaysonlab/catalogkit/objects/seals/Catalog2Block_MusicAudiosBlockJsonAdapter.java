...
public final class Catalog2Block_MusicAudiosBlockJsonAdapter extends AbstractC7188l {
    public final AbstractC7188l amazon;
    public final AbstractC7188l billing;
    public final AbstractC7188l crashlytics;
    public final AbstractC7188l loadAd;
    public final AbstractC7188l purchase;
    public final C0458l yandex = C0458l.m547strictfp("id", "layout", "actions", "next_from", "listen_events", "audios_ids");

    public Catalog2Block_MusicAudiosBlockJsonAdapter(C12952l c12952l) {
    ...
    public final void billing(C3631l c3631l, Object obj) {
        ...
        Catalog2Block.MusicAudiosBlock musicAudiosBlock = (Catalog2Block.MusicAudiosBlock) obj;
        c3631l.mopub();
        c3631l.isVip("id");
        this.loadAd.billing(c3631l, musicAudiosBlock.yandex);
        c3631l.isVip("layout");
        this.crashlytics.billing(c3631l, musicAudiosBlock.loadAd);
        c3631l.isVip("actions");
        this.amazon.billing(c3631l, musicAudiosBlock.crashlytics);
        c3631l.isVip("next_from");
        this.purchase.billing(c3631l, musicAudiosBlock.amazon);
        c3631l.isVip("listen_events");
        List list = musicAudiosBlock.purchase;
        AbstractC7188l abstractC7188l = this.billing;
        abstractC7188l.billing(c3631l, list);
        c3631l.isVip("audios_ids");
        abstractC7188l.billing(c3631l, musicAudiosBlock.billing);
        c3631l.adcel();
    }
    ...
    public final Object loadAd(C0396l c0396l) throws C8413l, EOFException {
        ...
        String str2 = str;
        if (i == -61) {
            return new Catalog2Block.MusicAudiosBlock(str2, (String) objLoadAd2, (List) objLoadAd, (List) objLoadAd3, (List) objLoadAd4, catalog2Layout);
        }
        return new Catalog2Block.MusicAudiosBlock(i, str, (String) objLoadAd2, (List) objLoadAd, (List) objLoadAd3, (List) objLoadAd4, catalog2Layout);
    }

    public final String toString() {
        return "GeneratedJsonAdapter(Catalog2Block.MusicAudiosBlock)";
    }
}
