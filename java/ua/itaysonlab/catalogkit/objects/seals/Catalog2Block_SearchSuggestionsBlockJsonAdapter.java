...
public final class Catalog2Block_SearchSuggestionsBlockJsonAdapter extends AbstractC7188l {
    public final AbstractC7188l amazon;
    public final AbstractC7188l billing;
    public final AbstractC7188l crashlytics;
    public final AbstractC7188l loadAd;
    public final AbstractC7188l purchase;
    public final C0458l yandex = C0458l.m547strictfp("id", "layout", "actions", "next_from", "listen_events", "suggestions_ids");

    public Catalog2Block_SearchSuggestionsBlockJsonAdapter(C12952l c12952l) {
    ...
    public final void billing(C3631l c3631l, Object obj) {
        ...
        Catalog2Block.SearchSuggestionsBlock searchSuggestionsBlock = (Catalog2Block.SearchSuggestionsBlock) obj;
        c3631l.mopub();
        c3631l.isVip("id");
        this.loadAd.billing(c3631l, searchSuggestionsBlock.yandex);
        c3631l.isVip("layout");
        this.crashlytics.billing(c3631l, searchSuggestionsBlock.loadAd);
        c3631l.isVip("actions");
        this.amazon.billing(c3631l, searchSuggestionsBlock.crashlytics);
        c3631l.isVip("next_from");
        this.purchase.billing(c3631l, searchSuggestionsBlock.amazon);
        c3631l.isVip("listen_events");
        List list = searchSuggestionsBlock.purchase;
        AbstractC7188l abstractC7188l = this.billing;
        abstractC7188l.billing(c3631l, list);
        c3631l.isVip("suggestions_ids");
        abstractC7188l.billing(c3631l, searchSuggestionsBlock.billing);
        c3631l.adcel();
    }
    ...
    public final Object loadAd(C0396l c0396l) throws C8413l, EOFException {
        ...
        String str2 = str;
        if (i == -61) {
            return new Catalog2Block.SearchSuggestionsBlock(str2, (String) objLoadAd2, (List) objLoadAd, (List) objLoadAd3, (List) objLoadAd4, catalog2Layout);
        }
        return new Catalog2Block.SearchSuggestionsBlock(i, str, (String) objLoadAd2, (List) objLoadAd, (List) objLoadAd3, (List) objLoadAd4, catalog2Layout);
    }

    public final String toString() {
        return "GeneratedJsonAdapter(Catalog2Block.SearchSuggestionsBlock)";
    }
}
