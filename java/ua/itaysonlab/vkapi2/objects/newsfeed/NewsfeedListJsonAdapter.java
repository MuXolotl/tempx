...
public final class NewsfeedListJsonAdapter extends AbstractC7188l {
    public final AbstractC7188l crashlytics;
    public final AbstractC7188l loadAd;
    public final C0458l yandex = C0458l.m547strictfp("id", "title");

    public NewsfeedListJsonAdapter(C12952l c12952l) {
    ...
    public final void billing(C3631l c3631l, Object obj) {
        ...
        c3631l.mopub();
        c3631l.isVip("id");
        AbstractC12589l.inmobi(newsfeedList.yandex, this.loadAd, c3631l, "title");
        this.crashlytics.billing(c3631l, newsfeedList.loadAd);
        c3631l.adcel();
    }
    ...
    public final Object loadAd(C0396l c0396l) throws C8413l, EOFException {
        ...
        if (setLicense.size() == 0) {
            return new NewsfeedList(num.intValue(), str);
        }
    ...
    public final String toString() {
        return "GeneratedJsonAdapter(NewsfeedList)";
    }
}
