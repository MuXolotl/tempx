...
public final class NewsfeedAudiosJsonAdapter extends AbstractC7188l {
    public final AbstractC7188l crashlytics;
    public final AbstractC7188l loadAd;
    public final C0458l yandex = C0458l.m547strictfp("count", "items");

    public NewsfeedAudiosJsonAdapter(C12952l c12952l) {
        Class cls = Integer.TYPE;
        C5746l c5746l = C5746l.f12138l;
        this.loadAd = c12952l.loadAd(cls, c5746l, "count");
        this.crashlytics = c12952l.loadAd(AbstractC15639l.mopub(List.class, AudioTrack.class), c5746l, "items");
    }
    ...
    public final void billing(C3631l c3631l, Object obj) {
        ...
        c3631l.mopub();
        c3631l.isVip("count");
        AbstractC12589l.inmobi(newsfeedAudios.yandex, this.loadAd, c3631l, "items");
        this.crashlytics.billing(c3631l, newsfeedAudios.loadAd);
        c3631l.adcel();
    }
    ...
    public final Object loadAd(C0396l c0396l) throws C8413l, EOFException {
        ...
        if (setLicense.size() == 0) {
            return new NewsfeedAudios(num.intValue(), list);
        }
    ...
    public final String toString() {
        return "GeneratedJsonAdapter(NewsfeedAudios)";
    }
}
