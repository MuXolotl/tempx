...
public final class GetTopTracks_PreapiJsonAdapter extends AbstractC7188l {
    public final AbstractC7188l loadAd;
    public final C0458l yandex = C0458l.m547strictfp("tracks");

    public GetTopTracks_PreapiJsonAdapter(C12952l c12952l) {
        this.loadAd = c12952l.loadAd(AbstractC15639l.mopub(List.class, UmaTrack.class), C5746l.f12138l, "tracks");
    }
    ...
    public final void billing(C3631l c3631l, Object obj) {
        ...
        c3631l.mopub();
        c3631l.isVip("tracks");
        this.loadAd.billing(c3631l, ((GetTopTracks$Preapi) obj).yandex);
        c3631l.adcel();
    }
    ...
    public final Object loadAd(C0396l c0396l) throws C8413l, EOFException {
        ...
        if (setLicense.size() == 0) {
            return new GetTopTracks$Preapi(list);
        }
    ...
    public final String toString() {
        return "GeneratedJsonAdapter(GetTopTracks.Preapi)";
    }
}
